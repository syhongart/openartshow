...
//
// ── 이 파일이 하지 않는 일 ───────────────────────────────────────────────────
// 마크업과 CSS는 world5.html에 있다. 여기서는 **찾아서 갱신만** 한다. 스타일 문자열을
...
/** 기본 선택자. world5.html의 마크업과 짝을 이룬다. */
const SEL = {
  root: '#w5-loading',
  bar: '#w5-loading-bar',
  label: '#w5-loading-label',
  percent: '#w5-loading-pct',
  note: '#w5-loading-note',
  copy: '#w5-loading-copy',
} as const;
