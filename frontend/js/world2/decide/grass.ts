...
export const GRASS_RINGS: readonly GrassRing[] = [
  { radius: 14, density: 55, scale: 1.00 },
  { radius: 34, density: 8, scale: 1.35 },
  { radius: 70, density: 1.4, scale: 1.90 },
];
 ...
 *
 * 110,000 의 근거: 3링 합이 **107,552** 다(위 `GRASS_RINGS` 의 산술). 여유가 2,448 뿐인
 ...
 */
export const MAX_BLADES = 110000;
