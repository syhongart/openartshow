 ...
 *
 * ── 0.2 → 0.45 (감독 판정 2026-08-20) ───────────────────────────────────────
 * 감독: *"40센치인더. 너무 잔잔하다."* → 비교 링크를 드린 뒤 *"출렁이는 것은 뭐든 링크
 * 다 좋다."*
 *
 ...
 *
 * 감독이 셋(0.3·0.45·0.6) 다 좋다고 했으므로 **가운데**를 고른다. 가장 큰 값이 아닌
 * 이유: 노브로 더 올리는 것은 언제든 되지만, 과하다는 판정이 나오면 **화면 판정을 다시
 * 받아야** 한다. 되돌리기가 비싼 쪽을 기본값으로 삼지 않는다.
 *
 ...
 */
export const WAVE_AMP_DEFAULT = 0.45;
