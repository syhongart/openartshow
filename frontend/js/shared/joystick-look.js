...
// leaf**"* 이기 때문이다. 이 모듈은 갤러리(라이브 `app/index.html`)와 world2(세계)가
// **함께** 쓸 것이고 아무것도 import 하지 않는다. `world-shared/` 는 *"세계 3종이 공유"*
// 라 라이브가 들어오면 그 이름이 거짓이 되고, `utils/`·`vendor/` 는 `frontend/` 직하라
// 남의 코드(three·peerjs)를 두는 자리다.
//
