...
`;continue}if((I=S.match(E))&&(L.gamma=parseFloat(I[1])),(I=S.match(R))&&(L.exposure=parseFloat(I[1])),(I=S.match(z))&&(L.valid|=2,L.format=I[1]),(I=S.match(B))&&(L.valid|=4,L.height=parseInt(I[1],10),L.width=parseInt(I[2],10)),L.valid&2&&L.valid&4)break}return L.valid&2||i(3,"missing format specifier"),L.valid&4||i(3,"missing image size specifier"),L},g=function(m,y,E){const R=y;if(R<8||R>32767||m[0]!==2||m[1]!==2||m[2]&128)return new Uint8Array(m);R!==(m[2]<<8|m[3])&&i(3,"wrong scanline width");const z=new Uint8Array(4*y*E);z.length||i(4,"unable to allocate buffer space");let B=0,L=0;const S=4*R,I=new Uint8Array(4),X=new Uint8Array(S);let U=E;for(;U>0&&L<m.byteLength;){L+4>m.byteLength&&i(1),I[0]=m[L++],I[1]=m[L++],I[2]=m[L++],I[3]=m[L++],(I[0]!=2||I[1]!=2||(I[2]<<8|I[3])!=R)&&i(3,"bad rgbe scanline format");let K=0,$;for(;K<S&&L<m.byteLength;){$=m[L++];const Z=$>128;if(Z&&($-=128),($===0||K+$>S)&&i(3,"bad scanline data"),Z){const Q=m[L++];for(let fe=0;fe<$;fe++)X[K++]=Q}else X.set(m.subarray(L,L+$),K),K+=$,L+=$}const W=R;for(let Z=0;Z<W;Z++){let Q=0;z[B]=X[Z+Q],Q+=R,z[B+1]=X[Z+Q],Q+=R,z[B+2]=X[Z+Q],Q+=R,z[B+3]=X[Z+Q],B+=4}U--}return z},d=function(m,y,E,R){const z=m[y+3],B=Math.pow(2,z-128)/255;E[R+0]=m[y+0]*B,E[R+1]=m[y+1]*B,E[R+2]=m[y+2]*B,E[R+3]=1},p=function(m,y,E,R){const z=m[y+3],B=Math.pow(2,z-128)/255;E[R+0]=be.toHalfFloat(Math.min(m[y+0]*B,65504)),E[R+1]=be.toHalfFloat(Math.min(m[y+1]*B,65504)),E[R+2]=be.toHalfFloat(Math.min(m[y+2]*B,65504)),E[R+3]=be.toHalfFloat(1)},v=new Uint8Array(e);v.pos=0;const h=b(v),f=h.width,N=h.height,M=g(v.subarray(v.pos),f,N);let _,T,C;switch(this.type){case Je:C=M.length/4;const m=new Float32Array(C*4);for(let E=0;E<C;E++)d(M,E*4,m,E*4);_=m,T=Je;break;case ge:C=M.length/4;const y=new Uint16Array(C*4);for(let E=0;E<C;E++)p(M,E*4,y,E*4);_=y,T=ge;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:f,height:N,data:_,header:h.string,gamma:h.gamma,exposure:h.exposure,type:T}}setDataType(e){return this.type=e,this}load(e,n,o,a){function r(i,c){switch(i.type){case Je:case ge:i.colorSpace=Ta,i.minFilter=Be,i.magFilter=Be,i.generateMipmaps=!1,i.flipY=!0;break}n&&n(i,c)}return super.load(e,r,o,a)}}const vo=[];function Bo(t){const n=document.createElement("canvas");n.width=1024,n.height=1024;const o=n.getContext("2d"),a=o.createLinearGradient(0,0,0,1024);for(const[u,x]of t.stops)a.addColorStop(u,x);if(o.fillStyle=a,o.fillRect(0,0,1024,1024),t.stars>0){const u=Ge(90210);for(let x=0;x<t.stars;x++){const w=u()*1024,b=u()*1024*.82,g=.4+u()*1.6,d=.35+u()*.65;if(u()>.965){const p=o.createRadialGradient(w,b,0,w,b,g*5);p.addColorStop(0,`rgba(255, 255, 255, ${d*.5})`),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.arc(w,b,g*5,0,Math.PI*2),o.fill()}o.fillStyle=`rgba(255, 255, 255, ${d})`,o.beginPath(),o.arc(w,b,g,0,Math.PI*2),o.fill()}}const r=Ge(13579),[i,c]=t.cloudAlpha;for(let u=0;u<t.cloudCount;u++){const x=r()*1024,w=1024*(.3+r()*.45),b=30+r()*90;for(let g=0;g<7;g++){const d=x+(r()-.5)*b*2.4,p=w+(r()-.5)*b*.7,v=b*(.35+r()*.5),h=o.createRadialGradient(d,p,0,d,p,v);h.addColorStop(0,`rgba(${t.cloudColor}, ${i+r()*(c-i)})`),h.addColorStop(1,`rgba(${t.cloudColor}, 0)`),o.fillStyle=h,o.beginPath(),o.arc(d,p,v,0,Math.PI*2),o.fill()}}const l=new ce(n);return l.colorSpace=Nt,l}const mr={daylight:"./assets/sky/day.hdr",sunset:"./assets/sky/sunset.hdr",night:"./assets/sky/night.jpg"};function we(t,e){const n=mr[e],o=r=>{r.minFilter=Be,r.magFilter=Be,t.map=r,t.needsUpdate=!0},a=()=>{};n.endsWith(".hdr")?new br().load(n,o,void 0,a):new _a().load(n,r=>{r.colorSpace=Nt,o(r)},void 0,a)}function xr(t,e,n){if(n){const r=(u,x)=>new H(new so(x,32,16),new Ht({map:Bo(u),side:Io,fog:!1,transparent:!0,depthWrite:!1,opacity:0})),i=r(Rt.night.sky,450),c=r(Rt.sunset.sky,448),l=r(Rt.daylight.sky,446);for(const u of[i,c,l])u.position.y=-70;return i.renderOrder=-3,c.renderOrder=-2,l.renderOrder=-1,t.add(i,c,l),we(l.material,"daylight"),we(c.material,"sunset"),we(i.material,"night"),{daylight:l,sunset:c,night:i}}const o=e===Rt.sunset?"sunset":e===Rt.night?"night":"daylight",a=new H(new so(450,32,16),new Ht({map:Bo(e.sky),side:Io,fog:!1}));return a.position.y=-70,t.add(a),we(a.material,o),null}function wr(t,e){const n=new H(new q(800,800),new rt({map:Po().map,normalMap:Po().normalMap,normalScale:new At(.6,.6),color:e.grassTint,roughness:.95,metalness:0}));n.rotation.x=-Math.PI/2,n.position.y=-.03,n.receiveShadow=!0,t.add(n);const o=new H(new q(400,900),new rt({color:e.sea.color,roughness:e.sea.roughness,metalness:e.sea.metalness}));o.rotation.x=-Math.PI/2,o.position.set(290,-.02,0),t.add(o);const a=new H(new q(8,900),new rt({color:13220758,roughness:.9}));a.rotation.x=-Math.PI/2,a.position.set(88,-.025,0),t.add(a);const r=Ge(97531),i=new $t;let c=4e4;function l(g,d,p){c+=733;const v=lo(c,{trunkLen:2.6*p,trunkRad:.24*p,maxLevel:2,leafScale:.95*p});v.position.set(g,0,d),v.rotation.y=r()*Math.PI*2,i.add(v)}[[-12,30,1],[4,31,1.15],[12,34,.9],[34,-18,1.1],[36,14,.95]].forEach(([g,d,p],v)=>{const h=lo(6e4+v*137,{trunkLen:3.2*p,trunkRad:.32*p,maxLevel:2,leafScale:1.1*p});h.position.set(g+(r()-.5)*2,0,d+(r()-.5)*2),h.rotation.y=r()*Math.PI*2,i.add(h)});const x=[[-20,33],[-4,35],[20,30],[-16,42],[-6,45],[6,43],[16,46],[0,52],[-24,50],[24,48]];for(const[g,d]of x)l(g+(r()-.5)*3,d+(r()-.5)*3,1+r()*.9);const w=[[40,-10],[44,22],[52,-18],[60,8],[48,-2]];for(const[g,d]of w)l(g+(r()-.5)*3,d+(r()-.5)*3,.9+r()*.8);const b=[[-35,-30],[-45,0],[-38,20],[-30,40],[20,-40],[-10,-38]];for(const[g,d]of b)l(g+(r()-.5)*4,d+(r()-.5)*4,1.1+r()*1);for(const g of Cn(i))t.add(g);return{seaMat:o.material}}function yr(t,e){const n=lo(31415,{trunkLen:4.6,trunkRad:.42,maxLevel:3,leafScale:1.4});n.position.set(7,0,14);for(const r of Cn(n))t.add(r);const o=new H(new Jt(.42,.72,.45,9),new rt({map:tr(),normalMap:Qa(),normalScale:new At(.9,.9),roughness:.95}));o.position.set(7,.22,14),o.castShadow=!0,t.add(o);const a=[];if(e.treeUplights)for(const[r,i]of[[5.6,13],[8.4,15]]){const c=new La(16756838,150,15,Math.PI/5,.9,1.8);c.position.set(r,.35,i);const l=new za;l.position.set(7,7,14),t.add(l),c.target=l,c.castShadow=!1,t.add(c),a.push(c)}return{treeUplights:a}}function Do(t,e){const n=new $t,o=new q(.16,.12);o.translate(-.09,0,0);const a=new q(.16,.12);a.translate(.09,0,0);const r=new Ht({color:e.color,side:ue}),i=new H(o,r),c=new H(a,r);i.rotation.x=-Math.PI/2,c.rotation.x=-Math.PI/2,n.add(i),n.add(c),t.add(n),vo.push({update(l){const u=l*e.speed+e.phase,x=e.cx+Math.cos(u)*e.rx,w=e.cz+Math.sin(u*e.zRatio)*e.rz,b=e.cy+Math.sin(l*e.bobSpeed+e.phase)*e.bobAmp,g=-Math.sin(u)*e.rx*e.speed,d=Math.cos(u*e.zRatio)*e.rz*e.zRatio*e.speed;n.rotation.y=Math.atan2(g,d),n.position.set(x,b,w);const p=Math.sin(l*e.flapSpeed)*1.1;i.rotation.y=p,c.rotation.y=-p}})}function vr(t,e){const n=new $t,o=new Ht({color:2763310,side:ue}),a=new q(1.6,.35);a.translate(-.8,0,0);const r=new q(1.6,.35);r.translate(.8,0,0);const i=new H(a,o),c=new H(r,o);i.rotation.x=-Math.PI/2,c.rotation.x=-Math.PI/2,n.add(i),n.add(c),t.add(n),vo.push({update(l){const u=l*e.speed+e.phase,x=e.cx+Math.cos(u)*e.radius,w=e.cz+Math.sin(u)*e.radius,b=e.cy+Math.sin(l*.3+e.phase)*2;n.rotation.y=-u-Math.PI/2,n.position.set(x,b,w);const g=Math.sin(l*e.flapSpeed+e.phase)*.55;i.rotation.y=g,c.rotation.y=-g}})}function kr(t){const e=Ge(86420),n=[15241786,15979338,15262938,13070264,8368864];for(let o=0;o<5;o++)Do(t,{cx:7,cz:14,cy:1.4+e()*3,rx:1+e()*2.2,rz:1+e()*2.2,zRatio:.7+e()*.6,speed:.35+e()*.4,phase:e()*Math.PI*2,bobSpeed:1.5+e()*1.5,bobAmp:.3+e()*.3,flapSpeed:9+e()*5,color:n[o%n.length]});for(let o=0;o<4;o++)Do(t,{cx:-14+o*10+e()*4,cz:30+e()*8,cy:1.2+e()*2,rx:1.5+e()*3,rz:1.5+e()*3,zRatio:.6+e()*.8,speed:.3+e()*.35,phase:e()*Math.PI*2,bobSpeed:1.2+e()*1.6,bobAmp:.35+e()*.4,flapSpeed:8+e()*5,color:n[(o+2)%n.length]});for(let o=0;o<3;o++)vr(t,{cx:20+e()*30,cz:-10+e()*40,cy:26+e()*12,radius:55+e()*45,speed:.04+e()*.03,phase:e()*Math.PI*2,flapSpeed:2.2+e()*1.2})}function Sr(t,e){const n=new bn(e.hemi.sky,e.hemi.ground,e.hemi.intensity);n.position.set(0,40,0),t.add(n);const o=new hn(e.ambient.color,e.ambient.intensity);t.add(o);const a=new Zt(e.sun.color,e.sun.intensity);a.position.set(...e.sun.pos),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.bias=-5e-4,a.shadow.normalBias=.02;const r=e.shadowCamera;a.shadow.camera.left=r.left,a.shadow.camera.right=r.right,a.shadow.camera.top=r.top,a.shadow.camera.bottom=r.bottom,a.shadow.camera.near=r.near,a.shadow.camera.far=r.far,t.add(a),t.add(a.target);const i=new Zt(e.fill.color,e.fill.intensity);return i.position.set(...e.fill.pos),t.add(i),{hemi:n,ambient:o,sun:a,fill:i}}function Cr(t){for(const e of vo)e.update(t)}let Tt=null,Go=0;function Er(t){Go+=t,Cr(Go),Tt&&(Tt.phase=(Tt.phase+t/ar)%1,An(Tt,In(Tt.phase)))}function Mr(t,e="daylight",n={}){const o=n.fullLights!==!1,a=e==="cycle",r=a?er():0,i=a?or(r):nr(e);t.background=new mn(i.background),t.fog=new xn(i.fog.color,i.fog.near,i.fog.far);const c=xr(t,i,a),l=wr(t,i);gr(t);const u=hr(t,i,o),x=yr(t,i),w=u.downlights,b=Sr(t,i);if(kr(t),a){const g=new Zt(Rt.night.sun.color,0);g.position.set(...Rt.night.sun.pos),t.add(g),t.add(g.target),Tt={scene:t,phase:r,sunLight:b.sun,hemiLight:b.hemi,ambientLight:b.ambient,moonLight:g,seaMat:l.seaMat,downlights:w,treeUplights:x.treeUplights,skyDomes:c},b.sun.shadow.camera.updateProjectionMatrix(),An(Tt,In(r))}else Tt=null;return{bounds:{minX:O.minX+.6,maxX:O.maxX-.6,minZ:O.minZ+.6,maxZ:O.maxZ-.6}}}let at=null,ie=null,ne=!1;function Tr(t,e){if(!at)return;const n=new StereoPannerNode(at,{pan:e});n.connect(ie);const o=2+Math.floor(Math.random()*4);let a=at.currentTime+.02;for(let r=0;r<o;r++){const i=at.createOscillator(),c=at.createGain();i.connect(c),c.connect(n);const l=t*(.85+Math.random()*.4),u=l*(Math.random()>.5?1.25:.78),x=.05+Math.random()*.1;i.type="sine",i.frequency.setValueAtTime(l,a),i.frequency.exponentialRampToValueAtTime(u,a+x),c.gain.setValueAtTime(1e-4,a),c.gain.exponentialRampToValueAtTime(.55,a+.012),c.gain.exponentialRampToValueAtTime(1e-4,a+x),i.start(a),i.stop(a+x+.02),a+=x+.04+Math.random()*.09}}function Lr(){const t=at.sampleRate*4,e=at.createBuffer(1,t,at.sampleRate),n=e.getChannelData(0);let o=0;for(let c=0;c<t;c++){const l=Math.random()*2-1;o=(o+.02*l)/1.02,n[c]=o*3.5}const a=at.createBufferSource();a.buffer=e,a.loop=!0;const r=at.createBiquadFilter();r.type="lowpass",r.frequency.value=400;const i=at.createGain();i.gain.value=.012,a.connect(r),r.connect(i),i.connect(ie),a.start()}function po(){if(!ne)return;const t=[{base:2600,pan:-.7},{base:3400,pan:.6},{base:4200,pan:.15}],e=t[Math.floor(Math.random()*t.length)];Tr(e.base,e.pan+(Math.random()-.5)*.3);const n=900+Math.random()*4200;setTimeout(po,n)}function zr(){if(!ne)try{at=new(window.AudioContext||window.webkitAudioContext),ie=at.createGain(),ie.gain.value=.05,ie.connect(at.destination),at.state==="suspended"&&at.resume(),ne=!0,Lr(),po(),setTimeout(()=>{ne&&po()},2500)}catch{ne=!1}}const ee=2.5,Ho=4.5,Fo=.0022,Xo=.0058,ye=bt.degToRad(89),_r=.03,Nr=7.5,ve=60,St=.45,Uo=.65,Ar=12;function Ir(t,e){for(const n of O.stairs){const o=Math.min(n.x0,n.x1),a=Math.max(n.x0,n.x1);if(t<o||t>a)continue;const r=Math.min(n.z0,n.z1),i=Math.max(n.z0,n.z1);if(e<r||e>i)continue;const c=bt.clamp((e-n.z0)/(n.z1-n.z0),0,1);return n.yFrom+c*(n.yTo-n.yFrom)}return null}function Rr(t,e,n){return e>=t.x0&&e<=t.x1&&n>=t.z0&&n<=t.z1}function Pr(t,e){return t>=O.minX&&t<=O.maxX&&e>=O.minZ&&e<=O.maxZ}function On(t,e){const n=[],o=Ir(t,e);if(o!==null&&n.push(o),Pr(t,e))for(const a of O.floors){const r=O.slabHoles[a.id]||[];let i=!1;for(const c of r)if(Rr(c,t,e)){i=!0;break}i||n.push(a.y)}else n.push(0);return n}function Or(t,e,n){const o=On(t,e);let a=null;for(const r of o)r<=n+Uo&&(a===null||r>a)&&(a=r);return a===null||n-a>Uo?null:a}function Br(t,e){let n=t,o=e;return e>O.minZ-St&&e<O.maxZ+St&&(n=bt.clamp(t,O.minX+St,O.maxX-St)),t>O.minX-St&&t<O.maxX+St&&(o=Math.max(e,O.minZ+St)),{x:n,z:o}}class Dr{constructor(e,n){if(this.camera=e,this.domElement=n,this.enabled=!1,this.euler=new wn(0,0,0,"YXZ"),this.camera.rotation.set(0,0,0),this.camera.rotation.order="YXZ",this.camera.position.set(0,Ct,8),this.keys={forward:!1,backward:!1,left:!1,right:!1,run:!1},this.velocity=new At(0,0),this.bobPhase=0,this.bobOffset=0,this.liftOffset=0,this.groundY=this.camera.position.y-Ct,this.moveTouch=null,this.lookTouch=null,!document.getElementById("lu-joy-style")){const o=document.createElement("style");o.id="lu-joy-style",o.textContent=`
