/* empty css              */import{n as Ze,D as Le,C as sa,a as la,S as To,c as Lo,e as ro,d as ca,f as da,g as pa,h as Ca,i as fa,j as ha,E as ga,k as ba,H as zo,l as ma,m as xa,o as Ba,p as qe,q as wa,r as ya,_ as Da}from"./chibi-builder-v2-34SjzgIS.js";import{W as fn}from"./vendor-three-DGS4Rzce.js";import{B as I,b as io,a as hn,E as vt,R as he,c as gn,A as so,g as Re,d as ue,M as va,L as Aa,w as Je,e as bn,f as ka,r as ze,h as Ea,P as _e,i as Sa,j as Ma,k as Ta,l as La,m as mn,n as za,o as _a,N as Fa,p as Na,q as xn,s as Ia,t as Bn,u as wn}from"./multiplayer-Bsog9O47.js";import{g as Ra,c as yn,a as Pa,b as lo,d as _o,e as Oa,f as Ga,T as Ft,m as Pe,h as Ha,i as Xa,r as Ya,j as Dn,k as vn,C as Ua}from"./scene-textures-Ze-_jqU5.js";import{m as Fe}from"./BufferGeometryUtils-Dv3y3wuG.js";import{u as Gt,s as G,aC as q,v as V,cn as ut,aA as $t,d4 as ja,cj as co,d5 as Jt,ce as An,h as zt,ca as $a,co as kn,D as de,d6 as Va,H as ge,aI as Qe,d7 as be,f as Wa,aa as Oe,B as Fo,cd as Ka,c$ as Za,cf as En,cb as Zt,d8 as qa,S as Lt,d9 as le,C as Sn,da as Mn,bL as Tn,cR as gt,aw as Ja,N as Ln,c8 as zn,P as _n,cx as Qa,a as No,db as tu,d2 as eu,d1 as ou,bU as nu,bY as au}from"./vendor-three-core-B_ITGQOV.js";import{P as uu,V as ru}from"./feed-yvp1pENn.js";import{g as Mt,o as Fn,P as me,l as iu,M as su,a as lu}from"./auth-aZ7HCW1S.js";import{p as cu}from"./main-gpu-BG9T9cr2.js";import"./GLTFLoader-qbhK0E03.js";function Io(t,e){let n=[t];for(const o of e){const a=[];for(const u of n){if(o.x1<=u.x0||o.x0>=u.x1||o.z1<=u.z0||o.z0>=u.z1){a.push(u);continue}const r=Math.max(u.x0,o.x0),l=Math.min(u.x1,o.x1),s=Math.max(u.z0,o.z0),d=Math.min(u.z1,o.z1);u.z0<s&&a.push({x0:u.x0,x1:u.x1,z0:u.z0,z1:s}),d<u.z1&&a.push({x0:u.x0,x1:u.x1,z0:d,z1:u.z1}),u.x0<r&&a.push({x0:u.x0,x1:r,z0:s,z1:d}),l<u.x1&&a.push({x0:l,x1:u.x1,z0:s,z1:d})}n=a}return n.filter(o=>o.x1-o.x0>.01&&o.z1-o.z0>.01)}function ft(t){return I.floors.find(e=>e.id===t)}function du(t,e){const n=yn(),o=16/50,a=t.x1-t.x0,u=t.z1-t.z0,r=n.map.clone(),l=n.normalMap.clone();for(const s of[r,l])s.needsUpdate=!0,s.repeat.set(o*a,o*u),s.offset.set((t.x0-I.minX)*o%1,(t.z0-I.minZ)*o%1);return new ut({map:r,normalMap:l,normalScale:new zt(.7,.7),color:e,roughness:.4,metalness:0})}function kt(t,e,n){const o=Pa(),a=o.map.clone(),u=o.normalMap.clone();for(const r of[a,u])r.needsUpdate=!0,r.repeat.set(t,e);return new ut({map:a,normalMap:u,normalScale:new zt(.55,.55),color:n||16777215,roughness:.9,metalness:0})}function Nn(){return new ut({map:lo().map,normalMap:lo().normalMap,normalScale:new zt(.35,.35),color:16777215,roughness:.92,metalness:0})}const ce=()=>new ut({color:2499615,roughness:.4,metalness:.75});function mt(t,e,n,o,a,u){const r=ce(),l=new kn({color:14214376,transparent:!0,opacity:.22,roughness:.08,side:de,depthWrite:!1}),s=Math.hypot(o-e,a-n),d=Math.atan2(o-e,a-n),m=(e+o)/2,x=(n+a)/2,g=new $t,h=new G(new Jt(.03,.03,s,10),r);h.rotation.x=Math.PI/2,h.position.y=1.05,g.add(h);const c=Math.max(2,Math.round(s/1.2)+1);for(let w=0;w<c;w++){const f=c===1?.5:w/(c-1),C=new G(new V(.045,1.05,.045),r);C.position.set(0,.525,-s/2+f*s),g.add(C)}const p=new G(new q(s,.85),l);p.rotation.y=Math.PI/2,p.position.y=.55,g.add(p),g.rotation.y=d,g.position.set(m,u,x),g.traverse(w=>{w.isMesh&&(w.castShadow=!0)}),t.add(g)}function pu(t,e){const n=kt(1.2,2.4),o=e.yTo-e.yFrom,a=e.z1-e.z0,u=24,r=o/u,l=a/u,s=e.x1-e.x0,d=(e.x0+e.x1)/2;for(let h=0;h<u;h++){const c=e.yFrom+(h+1)*r,p=c-e.yFrom+.25,w=new G(new V(s,p,l),n);w.position.set(d,c-p/2,e.z0+(h+.5)*l),w.castShadow=!0,w.receiveShadow=!0,t.add(w)}const m=ce(),x=Math.hypot(a,o),g=Math.atan2(o,a);for(const h of[e.x0+.06,e.x1-.06]){const c=new G(new Jt(.03,.03,x,10),m);c.rotation.x=Math.PI/2-g,c.position.set(h,(e.yFrom+e.yTo)/2+.95,(e.z0+e.z1)/2),c.castShadow=!0,t.add(c);for(const p of[.08,.5,.92]){const w=e.yFrom+o*p,f=new G(new V(.045,.95,.045),m);f.position.set(h,w+.475,e.z0+a*p),f.castShadow=!0,t.add(f)}}}function Cu(t,e,n,o,a,u,r){const l=e+I.clearH,s=.32,d=.14,m=1.1,x=kt(2,.4,13617599),g=new ut({color:3486253,normalMap:lo().normalMap,normalScale:new zt(.25,.25),roughness:.95}),h=new ut({color:1710102,roughness:.5,metalness:.6}),c=new ut({color:16774880,emissive:a.downlight.emissive,emissiveIntensity:2.5*(a.downlight.intensity/22),roughness:1}),p=[],w=[],f=[];for(const C of n){const L=C.x1-C.x0,k=C.z1-C.z0,T=new G(new q(L,k),g);T.rotation.x=Math.PI/2,T.position.set((C.x0+C.x1)/2,l+s,(C.z0+C.z1)/2),t.add(T);const E=Math.ceil((C.z0-I.minZ)/m);for(let b=E;;b++){const B=I.minZ+b*m;if(B>C.z1-.05)break;if(B<C.z0+.05)continue;const A=new V(L,s,d);A.translate((C.x0+C.x1)/2,l+s/2,B),p.push(A)}const v=Math.ceil((C.x0-I.minX)/m);for(let b=v;;b++){const B=I.minX+b*m;if(B>C.x1-.05)break;if(B<C.x0+.05)continue;const A=new V(d,s,k);A.translate(B,l+s/2,(C.z0+C.z1)/2),p.push(A)}for(let b=v;;b++){const B=I.minX+b*m+m/2;if(B>C.x1-.2)break;if(!(B<C.x0+.2))for(let A=E;;A++){const F=I.minZ+A*m+m/2;if(F>C.z1-.2)break;if(F<C.z0+.2||(b*7+A*5)%3!==0)continue;const M=new Jt(.07,.08,.1,12);M.translate(B,l+s-.06,F),w.push(M);const R=new Jt(.055,.055,.02,12);R.translate(B,l+s-.12,F),f.push(R)}}}if(p.length){const C=new G(Fe(p),x);C.castShadow=!0,t.add(C)}if(w.length&&t.add(new G(Fe(w),h)),f.length&&t.add(new G(Fe(f),c)),r)for(const[C,L]of u){const k=new $a(a.downlight.color,a.downlight.intensity*.7,9,2);k.position.set(C,l-.15,L),t.add(k),o.push(k)}return c}function fu(t){const e=new kn({color:14478578,transparent:!0,opacity:.1,roughness:.05,side:de,depthWrite:!1}),n=ce(),o=I.maxZ,a=I.maxX-I.minX,u=ft("f1"),r=ft("f2"),l=I.clearH;for(const[p,w]of[[I.minX,-1.5],[1.5,I.maxX]]){const f=w-p,C=new G(new q(f,l),e);C.position.set((p+w)/2,u.y+l/2,o),C.rotation.y=Math.PI,t.add(C)}for(let p=I.minX;p<=I.maxX+.01;p+=2.2){if(p>-1.5&&p<1.5)continue;const w=new G(new V(.12,l,.12),n);w.position.set(p,u.y+l/2,o),w.castShadow=!0,t.add(w)}for(const p of[-1.5,1.5]){const w=new G(new V(.18,l,.18),n);w.position.set(p,u.y+l/2,o),w.castShadow=!0,t.add(w)}const s=new G(new V(a,.14,.16),n);s.position.set(0,u.y+l-.07,o),t.add(s);const d=Nn(),m=new G(new V(a,1.2,I.wallT),d);m.position.set(0,r.y+.6,o),m.castShadow=!0,m.receiveShadow=!0,t.add(m);const x=new G(new V(a,I.clearH-2.6+.6,I.wallT),d);x.position.set(0,r.y+2.6+(I.clearH-2.6+.6)/2,o),x.castShadow=!0,x.receiveShadow=!0,t.add(x);const g=new G(new q(a,1.4),e);g.position.set(0,r.y+1.9,o),g.rotation.y=Math.PI,t.add(g);for(let p=I.minX;p<=I.maxX+.01;p+=2.2){const w=new G(new V(.08,1.4,.08),n);w.position.set(p,r.y+1.9,o),t.add(w)}const h=ft("b1"),c=new G(new V(a+.6,I.storyH,I.wallT),kt(4,1));c.position.set(0,h.y+I.storyH/2,o),t.add(c)}function hu(t,e,n){const o=I,a=o.maxX-o.minX,u=o.maxZ-o.minZ,r={x0:o.minX,x1:o.maxX,z0:o.minZ,z1:o.maxZ},l=[];let s=null;const d=["b1","f1","f2"];for(const D of o.floors){const _=o.slabHoles[D.id]||[],X=Io(r,_);for(const Y of X){const K=Y.x1-Y.x0,$=Y.z1-Y.z0,W=new G(new V(K,o.slabT,$),kt(K/6,$/6));W.position.set((Y.x0+Y.x1)/2,D.y-o.slabT/2,(Y.z0+Y.z1)/2),W.castShadow=!0,W.receiveShadow=!0,t.add(W);const Z=new G(new q(K,$),du(Y,D.id==="b1"?10127472:D.id==="roof"?13482132:16777215));Z.rotation.x=-Math.PI/2,Z.position.set((Y.x0+Y.x1)/2,D.y+.002,(Y.z0+Y.z1)/2),Z.receiveShadow=!0,t.add(Z)}}const m={b1:[[-6,-3],[0,-3],[6,-3],[0,3]],f1:[[-7,-4],[0,-4],[7,-4],[-7,4],[0,4],[7,4]],f2:[[-7,-4.5],[0,-4.5],[7,-4.5],[-7,5],[7,5]]},x={b1:"f1",f1:"f2",f2:"roof"};for(const D of d){const _=ft(D),X=o.slabHoles[x[D]]||[],Y=Io(r,X),K=Cu(t,_.y,Y,l,e,m[D],n);s||(s=K)}const g=kt(3,2),h=ft("roof").y-ft("b1").y,c=ft("b1").y+h/2,p=new G(new V(a+o.wallT*2,h,o.wallT),g);p.position.set(0,c,o.minZ-o.wallT/2),p.castShadow=!0,p.receiveShadow=!0,t.add(p);for(const[D,_]of[[o.minX-o.wallT/2,1],[o.maxX+o.wallT/2,1]]){const X=new G(new V(o.wallT,h,u),g);X.position.set(D,c,0),X.castShadow=!0,X.receiveShadow=!0,t.add(X)}for(const D of d){const _=ft(D),X=Nn(),Y=[{w:a,h:I.clearH,x:0,z:o.minZ+.02,ry:0},{w:u,h:I.clearH,x:o.maxX-.02,z:0,ry:-Math.PI/2},{w:u,h:I.clearH,x:o.minX+.02,z:0,ry:Math.PI/2}];for(const K of Y){const $=new G(new q(K.w,K.h),X);$.position.set(K.x,_.y+I.clearH/2,K.z),$.rotation.y=K.ry,$.receiveShadow=!0,t.add($)}}fu(t);for(const D of o.stairs)pu(t,D);const w=ft("f1").y,f=ft("f2").y,C=ft("roof").y;mt(t,-8.7,-7,-8.7,-1,w),mt(t,-10.7,-7,-8.7,-7,w),mt(t,-8.7,1,-8.7,7,f),mt(t,-10.7,1,-8.7,1,f),mt(t,-4,-3,5,-3,f),mt(t,-4,3,5,3,f),mt(t,-4,-3,-4,3,f),mt(t,5,-3,5,3,f),mt(t,8.7,1,8.7,7,C),mt(t,8.7,1,10.7,1,C);const L=kt(4,.5),k=1.1,T=.25,E=[{w:a+.6,d:T,x:0,z:o.minZ-T/2},{w:a+.6,d:T,x:0,z:o.maxZ+T/2},{w:T,d:u,x:o.minX-T/2,z:0},{w:T,d:u,x:o.maxX+T/2,z:0}];for(const D of E){const _=new G(new V(D.w,k,D.d),L);_.position.set(D.x,C+k/2,D.z),_.castShadow=!0,_.receiveShadow=!0,t.add(_)}const v=new ut({map:yn().map,color:12163695,roughness:.6});for(const[D,_]of[[-4,4],[2,-4]]){const X=new G(new V(2.2,.09,.55),v);X.position.set(D,C+.45,_),X.castShadow=!0,t.add(X);for(const Y of[-.9,.9]){const K=new G(new V(.08,.42,.5),ce());K.position.set(D+Y,C+.21,_),t.add(K)}}const b=new ut({color:5194806,roughness:.45,metalness:.65}),B=new $t,A=new G(new ja(1.3,.42,14,28,Math.PI),b);A.castShadow=!0,B.add(A);const F=new G(new co(.55,18,14),b);F.scale.set(1.5,.75,1),F.position.set(1.1,-.95,.2),F.castShadow=!0,B.add(F),B.position.set(-2,C+1.35,.5),B.rotation.y=-.6,t.add(B);const M=new G(new Jt(1.9,1.9,.12,24),kt(1,1,14209994));M.position.set(-2,C+.06,.5),M.receiveShadow=!0,t.add(M);const R=new G(new V(2.8,.18,7.2),kt(1,2));R.position.set(9.7,C+2.6,4),R.castShadow=!0,t.add(R);for(const[D,_]of[[8.85,.8],[10.55,.8],[8.85,7.2],[10.55,7.2]]){const X=new G(new V(.12,2.6,.12),ce());X.position.set(D,C+1.3,_),t.add(X)}let S=null;return n||(S=new An(e.downlight.color,e.downlight.intensity*.022),t.add(S)),{downlights:{lights:l,warm:S,bulbMat:s}}}function gu(t){const{minX:e,maxX:n,minZ:o,maxZ:a,wallT:u}=I,r=.55,l=e+u/2,s=n-u/2,d=o+u/2,m=a-u/2,x=new Gt({map:Ra(),transparent:!0,depthWrite:!1});for(const g of I.floors){if(g.id==="roof")continue;const h=g.y+.018,c=[[s-l,(l+s)/2,d+r/2,Math.PI],[s-l,(l+s)/2,m-r/2,0],[m-d,l+r/2,(d+m)/2,-Math.PI/2],[m-d,s-r/2,(d+m)/2,Math.PI/2]];for(const[p,w,f,C]of c){const L=new G(new q(p,r),x);L.rotation.x=-Math.PI/2,L.rotation.z=C,L.position.set(w,h,f),L.renderOrder=1,t.add(L)}}}class bu extends Va{constructor(e){super(e),this.type=ge}parse(e){const r=function(b,B){switch(b){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(B||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(B||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(B||""));default:case 4:throw new Error("THREE.RGBELoader: Memory Error: "+(B||""))}},m=`
...
`;continue}if((_=D.match(A))&&(S.gamma=parseFloat(_[1])),(_=D.match(F))&&(S.exposure=parseFloat(_[1])),(_=D.match(M))&&(S.valid|=2,S.format=_[1]),(_=D.match(R))&&(S.valid|=4,S.height=parseInt(_[1],10),S.width=parseInt(_[2],10)),S.valid&2&&S.valid&4)break}return S.valid&2||r(3,"missing format specifier"),S.valid&4||r(3,"missing image size specifier"),S},h=function(b,B,A){const F=B;if(F<8||F>32767||b[0]!==2||b[1]!==2||b[2]&128)return new Uint8Array(b);F!==(b[2]<<8|b[3])&&r(3,"wrong scanline width");const M=new Uint8Array(4*B*A);M.length||r(4,"unable to allocate buffer space");let R=0,S=0;const D=4*F,_=new Uint8Array(4),X=new Uint8Array(D);let Y=A;for(;Y>0&&S<b.byteLength;){S+4>b.byteLength&&r(1),_[0]=b[S++],_[1]=b[S++],_[2]=b[S++],_[3]=b[S++],(_[0]!=2||_[1]!=2||(_[2]<<8|_[3])!=F)&&r(3,"bad rgbe scanline format");let K=0,$;for(;K<D&&S<b.byteLength;){$=b[S++];const Z=$>128;if(Z&&($-=128),($===0||K+$>D)&&r(3,"bad scanline data"),Z){const Q=b[S++];for(let Ce=0;Ce<$;Ce++)X[K++]=Q}else X.set(b.subarray(S,S+$),K),K+=$,S+=$}const W=F;for(let Z=0;Z<W;Z++){let Q=0;M[R]=X[Z+Q],Q+=F,M[R+1]=X[Z+Q],Q+=F,M[R+2]=X[Z+Q],Q+=F,M[R+3]=X[Z+Q],R+=4}Y--}return M},c=function(b,B,A,F){const M=b[B+3],R=Math.pow(2,M-128)/255;A[F+0]=b[B+0]*R,A[F+1]=b[B+1]*R,A[F+2]=b[B+2]*R,A[F+3]=1},p=function(b,B,A,F){const M=b[B+3],R=Math.pow(2,M-128)/255;A[F+0]=be.toHalfFloat(Math.min(b[B+0]*R,65504)),A[F+1]=be.toHalfFloat(Math.min(b[B+1]*R,65504)),A[F+2]=be.toHalfFloat(Math.min(b[B+2]*R,65504)),A[F+3]=be.toHalfFloat(1)},w=new Uint8Array(e);w.pos=0;const f=g(w),C=f.width,L=f.height,k=h(w.subarray(w.pos),C,L);let T,E,v;switch(this.type){case Qe:v=k.length/4;const b=new Float32Array(v*4);for(let A=0;A<v;A++)c(k,A*4,b,A*4);T=b,E=Qe;break;case ge:v=k.length/4;const B=new Uint16Array(v*4);for(let A=0;A<v;A++)p(k,A*4,B,A*4);T=B,E=ge;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:C,height:L,data:T,header:f.string,gamma:f.gamma,exposure:f.exposure,type:E}}setDataType(e){return this.type=e,this}load(e,n,o,a){function u(r,l){switch(r.type){case Qe:case ge:r.colorSpace=Wa,r.minFilter=Oe,r.magFilter=Oe,r.generateMipmaps=!1,r.flipY=!0;break}n&&n(r,l)}return super.load(e,u,o,a)}}const wo=[];function Ro(t){const n=document.createElement("canvas");n.width=1024,n.height=1024;const o=n.getContext("2d"),a=o.createLinearGradient(0,0,0,1024);for(const[d,m]of t.stops)a.addColorStop(d,m);if(o.fillStyle=a,o.fillRect(0,0,1024,1024),t.stars>0){const d=Pe(90210);for(let m=0;m<t.stars;m++){const x=d()*1024,g=d()*1024*.82,h=.4+d()*1.6,c=.35+d()*.65;if(d()>.965){const p=o.createRadialGradient(x,g,0,x,g,h*5);p.addColorStop(0,`rgba(255, 255, 255, ${c*.5})`),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.arc(x,g,h*5,0,Math.PI*2),o.fill()}o.fillStyle=`rgba(255, 255, 255, ${c})`,o.beginPath(),o.arc(x,g,h,0,Math.PI*2),o.fill()}}const u=Pe(13579),[r,l]=t.cloudAlpha;for(let d=0;d<t.cloudCount;d++){const m=u()*1024,x=1024*(.3+u()*.45),g=30+u()*90;for(let h=0;h<7;h++){const c=m+(u()-.5)*g*2.4,p=x+(u()-.5)*g*.7,w=g*(.35+u()*.5),f=o.createRadialGradient(c,p,0,c,p,w);f.addColorStop(0,`rgba(${t.cloudColor}, ${r+u()*(l-r)})`),f.addColorStop(1,`rgba(${t.cloudColor}, 0)`),o.fillStyle=f,o.beginPath(),o.arc(c,p,w,0,Math.PI*2),o.fill()}}const s=new le(n);return s.colorSpace=Lt,s}const mu={daylight:"./assets/sky/day.hdr",sunset:"./assets/sky/sunset.hdr",night:"./assets/sky/night.jpg"};function xe(t,e){const n=mu[e],o=u=>{u.minFilter=Oe,u.magFilter=Oe,t.map=u,t.needsUpdate=!0},a=()=>{};n.endsWith(".hdr")?new bu().load(n,o,void 0,a):new qa().load(n,u=>{u.colorSpace=Lt,o(u)},void 0,a)}function xu(t,e,n){if(n){const u=(d,m)=>new G(new co(m,32,16),new Gt({map:Ro(d),side:Fo,fog:!1,transparent:!0,depthWrite:!1,opacity:0})),r=u(Ft.night.sky,450),l=u(Ft.sunset.sky,448),s=u(Ft.daylight.sky,446);for(const d of[r,l,s])d.position.y=-70;return r.renderOrder=-3,l.renderOrder=-2,s.renderOrder=-1,t.add(r,l,s),xe(s.material,"daylight"),xe(l.material,"sunset"),xe(r.material,"night"),{daylight:s,sunset:l,night:r}}const o=e===Ft.sunset?"sunset":e===Ft.night?"night":"daylight",a=new G(new co(450,32,16),new Gt({map:Ro(e.sky),side:Fo,fog:!1}));return a.position.y=-70,t.add(a),xe(a.material,o),null}function Bu(t,e){const n=new G(new q(800,800),new ut({map:_o().map,normalMap:_o().normalMap,normalScale:new zt(.6,.6),color:e.grassTint,roughness:.95,metalness:0}));n.rotation.x=-Math.PI/2,n.position.y=-.03,n.receiveShadow=!0,t.add(n);const o=new G(new q(400,900),new ut({color:e.sea.color,roughness:e.sea.roughness,metalness:e.sea.metalness}));o.rotation.x=-Math.PI/2,o.position.set(290,-.02,0),t.add(o);const a=new G(new q(8,900),new ut({color:13220758,roughness:.9}));a.rotation.x=-Math.PI/2,a.position.set(88,-.025,0),t.add(a);const u=Pe(97531),r=new $t;let l=4e4;function s(h,c,p){l+=733;const w=io(l,{trunkLen:2.6*p,trunkRad:.24*p,maxLevel:2,leafScale:.95*p});w.position.set(h,0,c),w.rotation.y=u()*Math.PI*2,r.add(w)}[[-12,30,1],[4,31,1.15],[12,34,.9],[34,-18,1.1],[36,14,.95]].forEach(([h,c,p],w)=>{const f=io(6e4+w*137,{trunkLen:3.2*p,trunkRad:.32*p,maxLevel:2,leafScale:1.1*p});f.position.set(h+(u()-.5)*2,0,c+(u()-.5)*2),f.rotation.y=u()*Math.PI*2,r.add(f)});const m=[[-20,33],[-4,35],[20,30],[-16,42],[-6,45],[6,43],[16,46],[0,52],[-24,50],[24,48]];for(const[h,c]of m)s(h+(u()-.5)*3,c+(u()-.5)*3,1+u()*.9);const x=[[40,-10],[44,22],[52,-18],[60,8],[48,-2]];for(const[h,c]of x)s(h+(u()-.5)*3,c+(u()-.5)*3,.9+u()*.8);const g=[[-35,-30],[-45,0],[-38,20],[-30,40],[20,-40],[-10,-38]];for(const[h,c]of g)s(h+(u()-.5)*4,c+(u()-.5)*4,1.1+u()*1);for(const h of hn(r))t.add(h);return{seaMat:o.material}}function wu(t,e){const n=io(31415,{trunkLen:4.6,trunkRad:.42,maxLevel:3,leafScale:1.4});n.position.set(7,0,14);for(const u of hn(n))t.add(u);const o=new G(new Jt(.42,.72,.45,9),new ut({map:Ga(),normalMap:Oa(),normalScale:new zt(.9,.9),roughness:.95}));o.position.set(7,.22,14),o.castShadow=!0,t.add(o);const a=[];if(e.treeUplights)for(const[u,r]of[[5.6,13],[8.4,15]]){const l=new Ka(16756838,150,15,Math.PI/5,.9,1.8);l.position.set(u,.35,r);const s=new Za;s.position.set(7,7,14),t.add(s),l.target=s,l.castShadow=!1,t.add(l),a.push(l)}return{treeUplights:a}}function Po(t,e){const n=new $t,o=new q(.16,.12);o.translate(-.09,0,0);const a=new q(.16,.12);a.translate(.09,0,0);const u=new Gt({color:e.color,side:de}),r=new G(o,u),l=new G(a,u);r.rotation.x=-Math.PI/2,l.rotation.x=-Math.PI/2,n.add(r),n.add(l),t.add(n),wo.push({update(s){const d=s*e.speed+e.phase,m=e.cx+Math.cos(d)*e.rx,x=e.cz+Math.sin(d*e.zRatio)*e.rz,g=e.cy+Math.sin(s*e.bobSpeed+e.phase)*e.bobAmp,h=-Math.sin(d)*e.rx*e.speed,c=Math.cos(d*e.zRatio)*e.rz*e.zRatio*e.speed;n.rotation.y=Math.atan2(h,c),n.position.set(m,g,x);const p=Math.sin(s*e.flapSpeed)*1.1;r.rotation.y=p,l.rotation.y=-p}})}function yu(t,e){const n=new $t,o=new Gt({color:2763310,side:de}),a=new q(1.6,.35);a.translate(-.8,0,0);const u=new q(1.6,.35);u.translate(.8,0,0);const r=new G(a,o),l=new G(u,o);r.rotation.x=-Math.PI/2,l.rotation.x=-Math.PI/2,n.add(r),n.add(l),t.add(n),wo.push({update(s){const d=s*e.speed+e.phase,m=e.cx+Math.cos(d)*e.radius,x=e.cz+Math.sin(d)*e.radius,g=e.cy+Math.sin(s*.3+e.phase)*2;n.rotation.y=-d-Math.PI/2,n.position.set(m,g,x);const h=Math.sin(s*e.flapSpeed+e.phase)*.55;r.rotation.y=h,l.rotation.y=-h}})}function Du(t){const e=Pe(86420),n=[15241786,15979338,15262938,13070264,8368864];for(let o=0;o<5;o++)Po(t,{cx:7,cz:14,cy:1.4+e()*3,rx:1+e()*2.2,rz:1+e()*2.2,zRatio:.7+e()*.6,speed:.35+e()*.4,phase:e()*Math.PI*2,bobSpeed:1.5+e()*1.5,bobAmp:.3+e()*.3,flapSpeed:9+e()*5,color:n[o%n.length]});for(let o=0;o<4;o++)Po(t,{cx:-14+o*10+e()*4,cz:30+e()*8,cy:1.2+e()*2,rx:1.5+e()*3,rz:1.5+e()*3,zRatio:.6+e()*.8,speed:.3+e()*.35,phase:e()*Math.PI*2,bobSpeed:1.2+e()*1.6,bobAmp:.35+e()*.4,flapSpeed:8+e()*5,color:n[(o+2)%n.length]});for(let o=0;o<3;o++)yu(t,{cx:20+e()*30,cz:-10+e()*40,cy:26+e()*12,radius:55+e()*45,speed:.04+e()*.03,phase:e()*Math.PI*2,flapSpeed:2.2+e()*1.2})}function vu(t,e){const n=new En(e.hemi.sky,e.hemi.ground,e.hemi.intensity);n.position.set(0,40,0),t.add(n);const o=new An(e.ambient.color,e.ambient.intensity);t.add(o);const a=new Zt(e.sun.color,e.sun.intensity);a.position.set(...e.sun.pos),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.bias=-5e-4,a.shadow.normalBias=.02;const u=e.shadowCamera;a.shadow.camera.left=u.left,a.shadow.camera.right=u.right,a.shadow.camera.top=u.top,a.shadow.camera.bottom=u.bottom,a.shadow.camera.near=u.near,a.shadow.camera.far=u.far,t.add(a),t.add(a.target);const r=new Zt(e.fill.color,e.fill.intensity);return r.position.set(...e.fill.pos),t.add(r),{hemi:n,ambient:o,sun:a,fill:r}}function Au(t){for(const e of wo)e.update(t)}let Et=null,Oo=0;function ku(t){Oo+=t,Au(Oo),Et&&(Et.phase=(Et.phase+t/Ua)%1,Dn(Et,vn(Et.phase)))}function Eu(t,e="daylight",n={}){const o=n.fullLights!==!1,a=e==="cycle",u=a?Ha():0,r=a?Xa(u):Ya(e);t.background=new Sn(r.background),t.fog=new Mn(r.fog.color,r.fog.near,r.fog.far);const l=xu(t,r,a),s=Bu(t,r);gu(t);const d=hu(t,r,o),m=wu(t,r),x=d.downlights,g=vu(t,r);if(Du(t),a){const h=new Zt(Ft.night.sun.color,0);h.position.set(...Ft.night.sun.pos),t.add(h),t.add(h.target),Et={scene:t,phase:u,sunLight:g.sun,hemiLight:g.hemi,ambientLight:g.ambient,moonLight:h,seaMat:s.seaMat,downlights:x,treeUplights:m.treeUplights,skyDomes:l},g.sun.shadow.camera.updateProjectionMatrix(),Dn(Et,vn(u))}else Et=null;return{bounds:{minX:I.minX+.6,maxX:I.maxX-.6,minZ:I.minZ+.6,maxZ:I.maxZ-.6}}}let at=null,re=null,ne=!1;function Su(t,e){if(!at)return;const n=new StereoPannerNode(at,{pan:e});n.connect(re);const o=2+Math.floor(Math.random()*4);let a=at.currentTime+.02;for(let u=0;u<o;u++){const r=at.createOscillator(),l=at.createGain();r.connect(l),l.connect(n);const s=t*(.85+Math.random()*.4),d=s*(Math.random()>.5?1.25:.78),m=.05+Math.random()*.1;r.type="sine",r.frequency.setValueAtTime(s,a),r.frequency.exponentialRampToValueAtTime(d,a+m),l.gain.setValueAtTime(1e-4,a),l.gain.exponentialRampToValueAtTime(.55,a+.012),l.gain.exponentialRampToValueAtTime(1e-4,a+m),r.start(a),r.stop(a+m+.02),a+=m+.04+Math.random()*.09}}function Mu(){const t=at.sampleRate*4,e=at.createBuffer(1,t,at.sampleRate),n=e.getChannelData(0);let o=0;for(let l=0;l<t;l++){const s=Math.random()*2-1;o=(o+.02*s)/1.02,n[l]=o*3.5}const a=at.createBufferSource();a.buffer=e,a.loop=!0;const u=at.createBiquadFilter();u.type="lowpass",u.frequency.value=400;const r=at.createGain();r.gain.value=.012,a.connect(u),u.connect(r),r.connect(re),a.start()}function po(){if(!ne)return;const t=[{base:2600,pan:-.7},{base:3400,pan:.6},{base:4200,pan:.15}],e=t[Math.floor(Math.random()*t.length)];Su(e.base,e.pan+(Math.random()-.5)*.3);const n=900+Math.random()*4200;setTimeout(po,n)}function Tu(){if(!ne)try{at=new(window.AudioContext||window.webkitAudioContext),re=at.createGain(),re.gain.value=.05,re.connect(at.destination),at.state==="suspended"&&at.resume(),ne=!0,Mu(),po(),setTimeout(()=>{ne&&po()},2500)}catch{ne=!1}}const ee=2.5,Go=4.5,Ho=.0022,Xo=.0058,Be=gt.degToRad(89),Lu=.03,zu=7.5,we=60,Dt=.45,Yo=.65,_u=12;function Fu(t,e){for(const n of I.stairs){const o=Math.min(n.x0,n.x1),a=Math.max(n.x0,n.x1);if(t<o||t>a)continue;const u=Math.min(n.z0,n.z1),r=Math.max(n.z0,n.z1);if(e<u||e>r)continue;const l=gt.clamp((e-n.z0)/(n.z1-n.z0),0,1);return n.yFrom+l*(n.yTo-n.yFrom)}return null}function Nu(t,e,n){return e>=t.x0&&e<=t.x1&&n>=t.z0&&n<=t.z1}function Iu(t,e){return t>=I.minX&&t<=I.maxX&&e>=I.minZ&&e<=I.maxZ}function In(t,e){const n=[],o=Fu(t,e);if(o!==null&&n.push(o),Iu(t,e))for(const a of I.floors){const u=I.slabHoles[a.id]||[];let r=!1;for(const l of u)if(Nu(l,t,e)){r=!0;break}r||n.push(a.y)}else n.push(0);return n}function Ru(t,e,n){const o=In(t,e);let a=null;for(const u of o)u<=n+Yo&&(a===null||u>a)&&(a=u);return a===null||n-a>Yo?null:a}function Pu(t,e){let n=t,o=e;return e>I.minZ-Dt&&e<I.maxZ+Dt&&(n=gt.clamp(t,I.minX+Dt,I.maxX-Dt)),t>I.minX-Dt&&t<I.maxX+Dt&&(o=Math.max(e,I.minZ+Dt)),{x:n,z:o}}class Ou{constructor(e,n){if(this.camera=e,this.domElement=n,this.enabled=!1,this.euler=new Tn(0,0,0,"YXZ"),this.camera.rotation.set(0,0,0),this.camera.rotation.order="YXZ",this.camera.position.set(0,vt,8),this.keys={forward:!1,backward:!1,left:!1,right:!1,run:!1},this.velocity=new zt(0,0),this.bobPhase=0,this.bobOffset=0,this.liftOffset=0,this.groundY=this.camera.position.y-vt,this.moveTouch=null,this.lookTouch=null,!document.getElementById("lu-joy-style")){const o=document.createElement("style");o.id="lu-joy-style",o.textContent=`
...
`,e=document.createElement("style");e.id="lu-styles",e.textContent=t,document.head.appendChild(e)}function i(t,e={},n=[]){const o=document.createElement(t);for(const[a,u]of Object.entries(e))a==="className"?o.className=u:a==="text"?o.textContent=u:o.setAttribute(a,u);for(const a of n)o.appendChild(a);return o}const ju="lu-chibi-look::",$u="lu-chibi-thumb::",Vu="lu-chibi-closet::",Wu="lu-chibi-look-v1",Ku="lu-chibi-look-thumb-v1",jo=12;function $e(){const t=Mt();return t&&t.provider&&t.name?`${t.provider}:${t.name}`:"guest"}function Ge(t){return ju+(t||$e())}function yo(t){return $u+(t||$e())}function Pn(t){return Vu+(t||$e())}function Zu(){try{const t=localStorage.getItem(Wu);if(t&&!localStorage.getItem(Ge("guest"))){localStorage.setItem(Ge("guest"),t);const e=localStorage.getItem(Ku);e&&localStorage.setItem(yo("guest"),e)}}catch{}}Zu();function On(t){try{const e=localStorage.getItem(Ge(t));if(!e)return null;const n=JSON.parse(e);return n&&typeof n=="object"?n:null}catch{return null}}function qu(t,e){try{return localStorage.setItem(Ge(e),JSON.stringify(t)),!0}catch{return!1}}function $o(t){try{return localStorage.getItem(yo(t))||""}catch{return""}}function Ju(t,e){try{localStorage.setItem(yo(e),t)}catch{}}let Do=null;function Qu(t){Do=t}function Gn(){return Do||On()}Fn(()=>{Do=null});function to(t){try{const e=localStorage.getItem(Pn(t));if(!e)return[];const n=JSON.parse(e);return Array.isArray(n)?n:[]}catch{return[]}}function Vo(t,e){try{return localStorage.setItem(Pn(e),JSON.stringify(t)),!0}catch{return!1}}function tr(t,e,n){try{const o=document.createElement("canvas");return o.width=e,o.height=n,o.getContext("2d").drawImage(t,0,0,e,n),o.toDataURL("image/jpeg",.72)}catch{return""}}let J=null,et=null,Wt=null,ye=0,De=!1,eo=0,ve=0,oo=Math.PI;const er=gt.degToRad(18),or=.6,Wo='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M4.5 19.5C4.5 10 11 4 20 4c0 9-6 15.5-15.5 15.5A1 1 0 0 1 4.5 19.5Z"/><path d="M6.7 17.3C10.2 13.3 14.2 9.3 18 5.5" stroke="rgba(255,255,255,0.55)" stroke-width="1.3" stroke-linecap="round" fill="none"/></svg>',nr=[{id:"species",label:"종족",icon:'<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="7" cy="8.3" r="2.1"/><circle cx="12" cy="6.1" r="2.1"/><circle cx="17" cy="8.3" r="2.1"/><path d="M12 11.6c-3.4 0-6.1 2.4-6.1 5.2 0 2 1.8 3.3 3.7 2.6.9-.3 1.7-.3 2.6 0 1.9.7 3.7-.6 3.7-2.6 0-2.8-2.5-5.2-5.9-5.2Z"/></svg>'},{id:"face",label:"얼굴",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="8"/><circle cx="9" cy="10.6" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="10.6" r="0.9" fill="currentColor" stroke="none"/><path d="M8.6 14.6c1 1.1 2.1 1.7 3.4 1.7s2.4-.6 3.4-1.7"/></svg>'},{id:"hair",label:"헤어",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" aria-hidden="true"><path d="M5 12.5C5 8 8.1 4.5 12 4.5s7 3.5 7 8"/><path d="M6.3 12.5v3.2M10.1 12.5v4.2M13.9 12.5v4.2M17.7 12.5v3.2"/></svg>'},{id:"outfit",label:"의상",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round" aria-hidden="true"><path d="M8.3 4.2 4.3 7.3l2 3 2-1.1v9.6h7.4V9.2l2 1.1 2-3-4-3.1c-.7 1-1.8 1.6-3.7 1.6s-3-.6-3.7-1.6Z"/></svg>'},{id:"acc",label:"장식",icon:'<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 3c.5 3.5 1.7 6.3 5.2 7.6-3.5 1.3-4.7 4.1-5.2 7.6-.5-3.5-1.7-6.3-5.2-7.6C10.3 9.3 11.5 6.5 12 3Z"/><circle cx="19" cy="5.2" r="1.2"/></svg>'},{id:"closet",label:"옷장",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="4.6" r="1.3"/><path d="M12 5.9v1.8"/><path d="M12 7.7 4.3 13.4h15.4L12 7.7Z"/><path d="M4.3 17.4h15.4"/></svg>'}];function ar(t){const{els:e,state:n,callbacks:o,setStatus:a}=t,u=i("button",{id:"lu-am-save",type:"button","aria-label":"이 캐릭터 사용",title:"이 캐릭터 사용",text:"✓"}),r=i("button",{id:"lu-am-close",type:"button","aria-label":"닫기",text:"×"}),l=i("span",{className:"lu-am-title-icon","aria-hidden":"true"});l.innerHTML=Wo;const s=i("div",{className:"lu-am-title"},[l,i("span",{text:"캐릭터 디자인"})]),d=i("div",{className:"lu-am-head-actions"},[u,r]),m=i("div",{className:"lu-am-head"},[s,d]),x=i("canvas",{width:"300",height:"400"}),g=i("div",{className:"lu-am-stage"},[x]),h=i("div",{className:"lu-am-stagewrap"},[g]),c=i("div",{className:"lu-am-preview"},[h]),p=["wave","jump","clap","dance","breakdance","run","jumpingjack","heart","kick"];let w=1,f=null,C=null,L=null,k=null;function T(z,P){if(typeof document>"u")return null;const N=document.createElement("canvas");N.width=2,N.height=256;const H=N.getContext("2d"),O=H.createLinearGradient(0,0,0,256);O.addColorStop(0,z),O.addColorStop(1,P),H.fillStyle=O,H.fillRect(0,0,2,256);const U=new le(N);return U.colorSpace=Lt,U}function E(z,P){if(typeof document>"u")return null;const N=512,H=307,O=document.createElement("canvas");O.width=N,O.height=H;const U=O.getContext("2d");U.fillStyle=z,U.fillRect(0,0,N,H);const ct=28,At=N/ct;U.fillStyle=P;for(let te=0;te<ct;te++)U.fillRect(te*At,0,At/2,H);const Qt=new le(O);return Qt.colorSpace=Lt,Qt.anisotropy=4,Qt}function v(){if(f)return;f=new fn({canvas:x,antialias:!0,alpha:!0}),f.setPixelRatio(Math.min(2,typeof window<"u"&&window.devicePixelRatio||1)),f.setSize(300,400,!1),f.shadowMap.enabled=!0,f.shadowMap.type=Ja,f.toneMapping=Ln,f.toneMappingExposure=1,f.outputColorSpace=Lt,C=new zn,C.background=T("#f0ead9","#ddd2bd")||new Sn("#ddd2bd"),C.fog=new Mn(14603199,5.5,10),L=new _n(30,300/400,.1,20),L.position.set(0,1,4),L.lookAt(0,.85,0),C.add(new En(16775924,2367256,.65));const z=new Zt(16777215,1.4);z.position.set(.7,2,2.6),C.add(z);const P=new Zt(16776696,.4);P.position.set(-1.8,1.1,1.6),C.add(P);const N=new Zt(16777215,0);N.position.set(.4,5,1),N.castShadow=!0,N.shadow.mapSize.set(512,512),N.shadow.camera.near=.5,N.shadow.camera.far=9,N.shadow.camera.left=-1.3,N.shadow.camera.right=1.3,N.shadow.camera.top=1.3,N.shadow.camera.bottom=-1.3,N.shadow.radius=35,N.shadow.blurSamples=24,N.shadow.bias=-5e-4,C.add(N),C.add(N.target);const H=new G(new q(6,6),new ut({color:12165231,roughness:.9,metalness:0}));H.rotation.x=-Math.PI/2,H.position.y=0,H.receiveShadow=!0,C.add(H);const O=new G(new q(6,6),new Qa({opacity:.3}));O.rotation.x=-Math.PI/2,O.position.y=.002,O.material.polygonOffset=!0,O.material.polygonOffsetFactor=-1,O.receiveShadow=!0,C.add(O);const U=E("#e2d7bf","#efe7d3"),ct=new G(new q(10,6),new ut({map:U,roughness:.9,metalness:0}));ct.position.set(0,2.2,-2.3),C.add(ct),k=new $t,k.rotation.y=Math.PI,C.add(k)}let b="species";const B=i("div",{className:"lu-am-nav",role:"tablist","aria-label":"캐릭터 디자인 카테고리"}),A=i("div",{className:"lu-am-panel"}),F=i("div",{className:"lu-am-tabpage",id:"lu-am-tabpanel",role:"tabpanel",tabindex:"0"});A.appendChild(B),A.appendChild(F),B.addEventListener("keydown",z=>{if(!["ArrowLeft","ArrowRight","Home","End"].includes(z.key))return;const P=[...B.querySelectorAll(".lu-am-navtab")];if(!P.length)return;const N=P.findIndex(U=>U.getAttribute("aria-selected")==="true");let H=N<0?0:N;z.key==="ArrowLeft"?H=(N-1+P.length)%P.length:z.key==="ArrowRight"?H=(N+1)%P.length:z.key==="Home"?H=0:z.key==="End"&&(H=P.length-1),z.preventDefault(),P[H].click();const O=B.querySelectorAll(".lu-am-navtab")[H];O&&O.focus()});const M=i("div",{className:"lu-am-body"},[c,A]),R=i("div",{className:"lu-am-card"},[m,M]),S=i("div",{id:"lu-chibi-maker",className:"lu"},[R]);document.body.appendChild(S);function D(z,P){J&&(J[z]=P,z==="species"&&P!=="human"&&To[P]&&Object.assign(J,To[P]),J=Ze(J),Ke(),Vt())}function _(z){J=Ze(Object.assign({},z)),Ke(),Vt()}function X(){for(const z of sa){const P=la.filter(H=>(H.cat||"human")===z.id);if(!P.length)continue;F.appendChild(i("div",{className:"lu-am-section-title",text:`${z.name} (${P.length})`}));const N=i("div",{className:"lu-am-tabs lu-am-presets"});for(const H of P){const O=i("button",{type:"button",className:"lu-am-tab lu-am-preset"}),U=H.look.skin||Le.skin,ct=H.look.top||H.look.hairColor||Le.top,At=i("span",{className:"lu-am-preset-dot","aria-hidden":"true"});At.style.background=`conic-gradient(${U} 0deg 180deg, ${ct} 180deg 360deg)`,O.appendChild(At),O.appendChild(i("span",{className:"lu-am-preset-label",text:H.name})),O.addEventListener("click",()=>_(H.look)),N.appendChild(O)}F.appendChild(N)}}function Y(z){const P=Lo.find(N=>N.id===z);return P&&P.name||"아야모"}function K(){if(!Mt())return;const z=$e();Q("내 옷장");const P=i("button",{type:"button",className:"lu-am-btn lu-closet-save",text:"＋ 지금 모습 옷장에 저장"});P.addEventListener("click",()=>{const O=to(z);if(O.length>=jo){a(`옷장은 최대 ${jo}벌까지 저장할 수 있어요`);return}const U={id:"c"+Date.now(),name:Y(J.species),look:JSON.parse(JSON.stringify(J)),thumb:Mo(120,160),ts:Date.now()};if(O.push(U),!Vo(O,z)){a("저장 공간이 부족해요 — 옷장에서 몇 벌을 지워 주세요");return}Vt()}),F.appendChild(P);const N=to(z);if(!N.length){F.appendChild(i("div",{className:"lu-closet-empty",text:"아직 저장한 옷이 없어요. 마음에 드는 모습을 저장해 두세요."}));return}const H=i("div",{className:"lu-closet-grid"});N.forEach(O=>{const U=i("div",{className:"lu-closet-cell"}),ct=i("button",{type:"button",className:"lu-closet-load",title:`${O.name} 불러오기`,"aria-label":`${O.name} 불러오기`});O.thumb&&(ct.style.backgroundImage=`url('${O.thumb}')`),ct.appendChild(i("span",{className:"lu-closet-name",text:O.name})),ct.addEventListener("click",()=>_(O.look));const At=i("button",{type:"button",className:"lu-closet-del",text:"×",title:"삭제","aria-label":`${O.name} 삭제`});At.addEventListener("click",Qt=>{Qt.stopPropagation();const te=to(z).filter(ia=>ia.id!==O.id);Vo(te,z),Vt()}),U.appendChild(ct),U.appendChild(At),H.appendChild(U)}),F.appendChild(H)}const $=(z,P)=>[{id:!1,name:z},{id:!0,name:P}];function W(z,P,N){F.appendChild(i("div",{className:"lu-am-section-title",text:z}));const H=i("div",{className:"lu-am-tabs"});P.forEach(O=>{const U=i("button",{type:"button",className:"lu-am-tab"+(J[N]===O.id?" lu-selected":""),text:O.name});U.addEventListener("click",()=>D(N,O.id)),H.appendChild(U)}),F.appendChild(H)}function Z(z,P,N){F.appendChild(i("div",{className:"lu-am-section-title",text:z}));const H=i("div",{className:"lu-swatches"});P.forEach(O=>{const U=i("button",{type:"button",className:"lu-swatch"+(J[N]===O?" lu-selected":""),style:`background:${O};`,title:O,"aria-label":`${z} ${O}`});U.addEventListener("click",()=>D(N,O)),H.appendChild(U)}),F.appendChild(H)}function Q(z){const P=i("div",{className:"lu-am-group-title"}),N=i("span",{className:"lu-am-group-icon","aria-hidden":"true"});N.innerHTML=Wo,P.appendChild(N),P.appendChild(i("span",{text:z})),F.appendChild(P)}function Ce(){B.textContent="";const z=!!Mt(),P=nr.filter(N=>N.id!=="closet"||z);P.some(N=>N.id===b)||(b="species"),P.forEach(N=>{const H=b===N.id,O=i("button",{type:"button",role:"tab",id:"lu-am-tab-"+N.id,className:"lu-am-navtab"+(H?" lu-selected":""),"aria-selected":H?"true":"false","aria-controls":"lu-am-tabpanel",tabindex:H?"0":"-1","aria-label":N.label});O.innerHTML=N.icon,O.appendChild(i("span",{className:"lu-am-navtab-label",text:N.label})),O.addEventListener("click",()=>{b!==N.id&&(b=N.id,Vt(),F.scrollTop=0)}),B.appendChild(O)}),F.setAttribute("aria-labelledby","lu-am-tab-"+b)}function Vt(){if(Ce(),F.textContent="",!J)return;const z=J.species&&J.species!=="human";b==="species"?(X(),Q(z?"종족 · 털색":"종족 · 성별 · 피부색"),W("종족",Lo,"species"),z||W("성별",ca,"gender"),Z(z?"털 색":"피부색",da,"skin")):b==="face"?(Q("얼굴"),W("얼굴형",pa,"face"),W("눈",Ca,"eyeStyle"),W("입",fa,"mouth"),z||W("수염",ha,"beardStyle"),W("볼터치",$("없음","있음"),"blush"),Z("눈동자 색",ga,"eyeColor")):b==="hair"?z?(Q("포인트"),Z("귀·꼬리 색",zo,"hairColor")):(Q("헤어"),W("헤어",ba,"hairStyle"),Z("머리 색",zo,"hairColor")):b==="outfit"?(Q("의상"),W("상의 패턴",ma,"pattern"),W("의상 세트",xa,"outfit"),W("하의",Ba,"bottomType"),Z("상의 색",qe,"top"),Z("하의 색",qe,"bottom"),Z("신발 색",qe,"shoes")):b==="acc"?(Q("장식"),W("머리 장식",wa,"acc"),W("안경",$("없음","착용"),"glasses"),W("헤일로",$("없음","있음"),"halo"),W("날개",$("없음","있음"),"wings"),W("가슴 하트",$("없음","있음"),"heart")):b==="closet"&&K()}function Ke(){!J||!k||(et&&(k.remove(et.group),et.dispose(),et=null),et=gn(ro(J),Rn," ",{blobShadow:!1}),et.group.traverse(z=>{z.isMesh&&(z.castShadow=!0)}),k.add(et.group))}function Eo(z){Wt=requestAnimationFrame(Eo);const P=ye?(z-ye)/1e3:0,N=Math.min(.1,P);if(ye=z,!De&&(ve+=N,k.rotation.y=oo+Math.sin(ve*or)*er,w-=P,w<=0&&et&&typeof et.playAction=="function")){const H=p[Math.floor(Math.random()*p.length)];et.playAction(H),w=(ya[H]||1.5)+.6+Math.random()*.9}et&&et.update(N,0),f.render(C,L)}function na(){Wt||(ye=0,Wt=requestAnimationFrame(Eo))}function aa(){Wt&&cancelAnimationFrame(Wt),Wt=null}x.addEventListener("pointerdown",z=>{De=!0,eo=z.clientX,c.classList.add("lu-dragging"),x.setPointerCapture(z.pointerId)}),x.addEventListener("pointermove",z=>{De&&(k.rotation.y+=(z.clientX-eo)*.012,eo=z.clientX)});const So=()=>{De=!1,c.classList.remove("lu-dragging"),oo=k.rotation.y,ve=0};x.addEventListener("pointerup",So),x.addEventListener("pointercancel",So),r.addEventListener("click",()=>fe()),S.addEventListener("click",z=>{z.target===S&&fe()});function Mo(z,P){try{return f?(f.render(C,L),tr(x,z,P)||f.domElement.toDataURL("image/png")):""}catch{return""}}function ua(){const P=!!Mt()?"저장하고 사용":"이 캐릭터 사용";u.setAttribute("aria-label",P),u.title=P}u.addEventListener("click",()=>{if(!J)return;const z=JSON.parse(JSON.stringify(J));Qu(z);const P=!!Mt();if(P){const N=qu(z),H=Mo(150,200);H&&Ju(H),N||a("저장 공간이 부족해요 — 옷장에서 몇 벌을 지워 주세요")}e&&e.lobby&&e.lobby.onChibiSaved(),n.entered&&typeof o.onAvatarChange=="function"&&o.onAvatarChange(ro(z)),P||a("이 캐릭터로 적용했어요 · 회원가입하면 저장돼요"),fe()});function ra(){b="species",J=Ze(Object.assign({},Le,Gn()||{})),ua(),v(),k.rotation.y=Math.PI,oo=Math.PI,ve=0,w=1,Ke(),Vt(),S.classList.add("lu-open"),n.chibiOpen=!0,na(),typeof o.onMakerToggle=="function"&&o.onMakerToggle(!0)}function fe(){S.classList.remove("lu-open"),n.chibiOpen=!1,aa(),et&&(k.remove(et.group),et.dispose(),et=null),typeof o.onMakerToggle=="function"&&o.onMakerToggle(!1)}return{open:ra,close:fe}}const ur=8,Ae=12;let y=null,tt={onEnter:null,onChatSend:null,onAvatarChange:null,onMakerToggle:null},Ko=so[0];const qt={chibiOpen:!1,entered:!1};let Co=null,Zo=!1,Ht=!1,fo=null,Rt=null,Xt=!1,ho=null,Yt=!1,go=null,He=null;const ke=120;let yt={onPrev:null,onNext:null,onExit:null,onToggleAuto:null};const Ut=typeof window<"u"&&"ontouchstart"in window||typeof matchMedia=="function"&&matchMedia("(pointer: coarse)").matches;let bt={onTour:null,onViewArtwork:null,onGuestbook:null,onCapture:null,onSelfView:null},jt=!1,rt={blob:null,dataUrl:"",galleryName:"",shareUrl:""},Pt=null,Xe=null,Tt=null,Ye=null;function rr(){const t=i("div",{id:"lu-loading",className:"lu"},[i("div",{className:"lu-spinner"}),i("div",{className:"lu-loading-text",text:"MUSEUM LOADING..."})]);return document.body.appendChild(t),t}function ir(){const t=i("div",{className:"lu-lobby-title",text:"OpenArtShow MUSEUM"}),e=i("div",{className:"lu-lobby-sub",text:"VIRTUAL EXHIBITION"}),n=i("div",{className:"lu-lobby-rule"}),o=i("div",{id:"lu-auth"}),a=i("div",{className:"lu-social-wrap"}),u=i("div",{className:"lu-logged-wrap"}),r=()=>{a.textContent="";for(const M of Object.keys(me)){const R=me[M],S=i("button",{className:`lu-social-btn lu-social-${M}`,type:"button"},[i("span",{className:"lu-social-badge",text:R.short}),i("span",{text:R.label})]);S.addEventListener("click",async()=>{S.disabled=!0,S.classList.add("lu-social-busy");try{await iu(M)}catch{}S.disabled=!1,S.classList.remove("lu-social-busy")}),a.appendChild(S)}a.appendChild(i("div",{className:"lu-social-note",text:"계정 연동 준비 중 — 지금은 프로필 미리보기로 동작합니다"}))},l=M=>{u.textContent="";const R=i("span",{className:"lu-logged-avatar",text:M.initial||M.name.slice(0,1)}),S=i("span",{className:"lu-logged-name",text:`${M.name}님`}),D=i("span",{className:"lu-logged-via",text:me[M.provider]?me[M.provider].short:""}),_=i("button",{className:"lu-logout-btn",type:"button",text:"로그아웃"});_.addEventListener("click",()=>lu()),u.appendChild(i("div",{className:"lu-logged-chip"},[R,S,D,_]))},s=M=>{M?(l(M),a.style.display="none",u.style.display="",x.value=M.name.slice(0,Ae)):(a.style.display="",u.style.display="none",(!x.value||Object.values(su).includes(x.value))&&(x.value="게스트")),p()};r(),o.appendChild(a),o.appendChild(u);const d=i("div",{className:"lu-auth-or"},[i("span",{text:"소셜 계정 연동 (준비 중)"})]),m=i("label",{className:"lu-field-label",for:"lu-nickname",text:"닉네임"}),x=i("input",{id:"lu-nickname",type:"text",maxlength:String(Ae),value:"게스트",autocomplete:"off",spellcheck:"false"}),g=i("div",{className:"lu-field-hint",text:`최대 ${Ae}자 · 비워두면 '게스트'로 입장합니다`}),h=i("div",{className:"lu-field-label",text:"캐릭터",style:"margin-top:26px;"}),c=i("button",{id:"lu-char-design",className:"lu-char-design-btn",type:"button","aria-label":"캐릭터 디자인 — 나만의 아야모 만들기"});function p(){const M=$o();c.textContent="";const R=i("span",{className:"lu-char-design-media"});M?(R.classList.add("lu-has-thumb"),R.style.backgroundImage=`url('${M}')`):R.textContent="🎨";const S=i("span",{className:"lu-char-design-txt"},[i("b",{text:"캐릭터 디자인"}),i("span",{text:M?"내 아야모 편집하기":"나만의 아야모 만들기 (선택)"})]);c.append(R,S,i("span",{className:"lu-char-design-arrow",text:"›"}))}p(),c.addEventListener("click",()=>vo());const w=i("button",{id:"lu-enter-btn",type:"button",text:"입장하기"}),f=i("div",{id:"lu-picker"}),C=i("div",{className:"lu-lobby-divider"}),L=i("a",{className:"lu-studio-link",href:"./studio.html",target:"_blank",rel:"noopener noreferrer",text:"작가 스튜디오에서 나만의 전시 만들기 →"}),k=i("div",{className:"lu-lobby-form"},[m,x,g,h,c,w,d,o]),T=i("div",{className:"lu-quick-enter"});function E(){T.textContent="";const M=Mt(),R=$o(),S=i("span",{className:"lu-quick-avatar"});R?S.style.backgroundImage=`url('${R}')`:S.textContent="🙂";const D=i("div",{className:"lu-quick-greet"},[i("b",{text:(M?`${M.name}님, `:"")+"다시 오셨어요"}),i("span",{text:"저장한 모습으로 바로 입장할 수 있어요"})]),_=i("button",{className:"lu-quick-btn",type:"button",text:"바로 입장"});_.addEventListener("click",A);const X=i("button",{className:"lu-quick-change",type:"button",text:"닉네임·캐릭터 바꾸기"});X.addEventListener("click",()=>{k.classList.remove("lu-collapsed"),T.style.display="none";try{x.focus()}catch{}}),T.append(S,D,_,X)}!!(Mt()||On())?(E(),k.classList.add("lu-collapsed")):T.style.display="none";const b=i("div",{className:"lu-lobby-card"},[t,e,n,T,k,f,C,L]),B=i("div",{id:"lu-lobby",className:"lu"},[b]);document.body.appendChild(B),s(Mt()),Fn(s);function A(){let M=x.value.trim().slice(0,Ae);M||(M="게스트");let R=0;for(let D=0;D<M.length;D++)R=R*31+M.charCodeAt(D)>>>0;Ko=so[R%so.length];const S=ro(Object.assign({},Le,Gn()||{}));typeof tt.onEnter=="function"&&tt.onEnter({nickname:M,color:Ko,char:S})}w.addEventListener("click",A),x.addEventListener("keydown",M=>{M.stopPropagation(),M.key==="Enter"&&A()}),x.addEventListener("keyup",M=>M.stopPropagation());function F(){p()}return{overlay:B,nickInput:x,pickerBox:f,onChibiSaved:F}}function sr(){const t=Ut?[["왼쪽 드래그","이동"],["오른쪽 드래그","시점 회전"],["캐릭터 탭","콕 찌르기"],["작품 카드","탭하여 크게 보기"]]:[["마우스 드래그","시점 회전"],["W A S D","이동"],["Shift","달리기"],["Enter","채팅"],["M","작품 목록"],["T","투어"],["G","방명록"],["V","내 모습 보기"],["C","캐릭터 디자인"],["P","사진 촬영"],["클릭","캐릭터 콕 찌르기"]],e=i("div",{id:"lu-controls",className:"lu lu-hud"});if(e.appendChild(i("div",{className:"lu-controls-title",text:"CONTROLS"})),t.forEach(([n,o])=>{const a=i("div",{},[i("span",{className:"lu-key",text:n}),i("span",{text:o})]);e.appendChild(a)}),document.body.appendChild(e),Ut){e.classList.add("lu-collapsed");const n=i("button",{id:"lu-controls-toggle",className:"lu lu-hud",type:"button","aria-label":"조작법 보기",text:"?"});n.addEventListener("click",()=>{e.classList.toggle("lu-collapsed")}),document.body.appendChild(n)}return e}function lr(){if(!Ut)return null;function t(){const C=y&&y.chat&&y.chat.wrap;if(!C)return;const L=C.classList.toggle("lu-chat-collapsed");!L&&y.chat.input?y.chat.input.focus():y.chat.input&&y.chat.input.blur(),u.classList.toggle("lu-on",!L)}const e={chat:'<path d="M20 15a2 2 0 0 1-2 2H9l-5 3V6a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2z"/>',tour:'<circle cx="12" cy="12" r="9"/><path d="M15.5 8.5l-2.1 4.9-4.9 2.1 2.1-4.9z"/>',capture:'<path d="M4 8h3l2-2.5h6L17 8h3a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1z"/><circle cx="12" cy="13" r="3.4"/>',more:'<circle cx="5.5" cy="12" r="1.2" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.2" fill="currentColor" stroke="none"/><circle cx="18.5" cy="12" r="1.2" fill="currentColor" stroke="none"/>',list:'<path d="M8.5 6h11.5M8.5 12h11.5M8.5 18h11.5"/><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/>',self:'<circle cx="12" cy="8" r="3.4"/><path d="M5.5 19a6.5 6.5 0 0 1 13 0"/>',help:'<path d="M9.2 9a2.9 2.9 0 1 1 4.2 2.6c-.9.45-1.4 1.05-1.4 2.1"/><circle cx="12" cy="17.4" r="1" fill="currentColor" stroke="none"/>',dress:'<path d="M9 4l3 3 3-3M9 4l-1.5 5 4.5 3 4.5-3L18 4M7.5 9l-2 8h13l-2-8"/>'};function n(C){const L=document.createElement("span");return L.innerHTML='<svg viewBox="0 0 24 24" aria-hidden="true">'+e[C]+"</svg>",L.firstChild}function o(C,L,k,T){const E=i("button",{className:C,type:"button","aria-label":L});E.appendChild(n(k)),E.appendChild(i("span",{className:"lu-dock-label",text:T}));const v=i("div",{className:"lu-dock-wrap"},[E]);return{b:E,wrap:v}}const a=o("lu-dock-btn","채팅 열기/닫기","chat","채팅"),u=a.b;a.wrap.style.display="none",u.addEventListener("click",t);const r=o("lu-dock-btn","투어 시작/종료","tour","투어"),l=r.b;l.addEventListener("click",()=>{typeof bt.onTour=="function"&&bt.onTour()});const s=o("lu-dock-btn lu-gold","사진 촬영","capture","캡처"),d=s.b;d.addEventListener("click",()=>{d.classList.remove("lu-cap-pop"),d.offsetWidth,d.classList.add("lu-cap-pop"),typeof bt.onCapture=="function"&&bt.onCapture()});const m=o("lu-dock-btn","더보기","more","메뉴"),x=m.b,g=i("div",{id:"lu-more-backdrop"}),h=i("div",{id:"lu-more-sheet"});function c(){h.classList.remove("lu-open"),g.classList.remove("lu-open")}function p(C,L,k){const T=i("button",{className:"lu-sheet-btn",type:"button"});return T.appendChild(n(C)),T.appendChild(i("span",{text:L})),T.addEventListener("click",()=>{c(),k()}),T}const w=i("div",{className:"lu-sheet-grid"},[p("list","작품 목록",()=>Wn()),p("self","내 모습",()=>{typeof bt.onSelfView=="function"&&bt.onSelfView()}),p("dress","캐릭터 디자인",()=>vo()),p("chat","채팅",t),p("help","조작법",()=>{const C=document.getElementById("lu-controls");C&&C.classList.toggle("lu-collapsed")})]);h.append(i("div",{className:"lu-sheet-handle"}),w),g.addEventListener("click",c),x.addEventListener("click",()=>{const C=h.classList.toggle("lu-open");g.classList.toggle("lu-open",C)}),document.body.appendChild(g),document.body.appendChild(h);const f=i("div",{id:"lu-dock",className:"lu lu-hud"},[a.wrap,r.wrap,s.wrap,m.wrap]);return document.body.appendChild(f),Ot={chatBtn:u,chatWrap:a.wrap,tourBtn:l,selfBtn:null,dock:f},f}let Ot=null;function qo(t,e){Ot&&t==="tour"&&Ot.tourBtn&&Ot.tourBtn.classList.toggle("lu-on",!!e)}function cr(){const t=i("span",{text:"--"}),e=i("div",{className:"lu-stat"});e.append("FPS ");const n=i("b");n.appendChild(t),e.appendChild(n);const o=i("div",{id:"lu-topright",className:"lu lu-hud"},[e]);return document.body.appendChild(o),{wrap:o,fps:t,count:i("span"),countWrap:null}}function dr(){const t=i("div",{id:"lu-status",className:"lu lu-hud"});return document.body.appendChild(t),t}function pr(){const t=i("div",{id:"lu-chat-log"}),e=i("input",{id:"lu-chat-input",type:"text",maxlength:"120",placeholder:Ut?"탭하여 채팅…":"Enter 키로 채팅…",autocomplete:"off",spellcheck:"false"}),n=i("div",{id:"lu-chat",className:"lu lu-hud"},[t,e]);return Ut&&n.classList.add("lu-chat-collapsed"),document.body.appendChild(n),e.addEventListener("keydown",o=>{if(o.stopPropagation(),o.key==="Enter"){const a=e.value.trim();e.value="",e.blur(),a&&typeof tt.onChatSend=="function"&&tt.onChatSend(a)}else o.key==="Escape"&&(e.value="",e.blur())}),e.addEventListener("keyup",o=>o.stopPropagation()),e.addEventListener("keypress",o=>o.stopPropagation()),{wrap:n,log:t,input:e}}function Cr(){const t=i("div",{className:"lu-art-eyebrow",text:"ARTWORK"}),e=i("div",{className:"lu-art-title"}),n=i("div",{className:"lu-art-meta"}),o=i("div",{className:"lu-art-rule"}),a=i("div",{className:"lu-art-desc"}),u=i("button",{className:"lu-art-hint",type:"button"});Ut?u.appendChild(document.createTextNode("크게 보기")):(u.appendChild(i("span",{className:"lu-key",text:"E"})),u.appendChild(document.createTextNode(" — 크게 보기"))),u.addEventListener("click",l=>{l.stopPropagation(),typeof bt.onViewArtwork=="function"&&bt.onViewArtwork()});const r=i("div",{id:"lu-artwork",className:"lu"},[t,e,n,o,a,u]);return Ut&&r.addEventListener("click",()=>{typeof bt.onViewArtwork=="function"&&bt.onViewArtwork()}),document.body.appendChild(r),{panel:r,title:e,meta:n,desc:a}}function fr(){const t=i("span",{className:"lu-topbar-title"}),e=i("b",{text:"1"}),n=i("span",{className:"lu-topbar-count"});n.appendChild(e),n.append(" 명");const o=i("div",{id:"lu-topbar",className:"lu lu-hud lu-cut-s lu-empty"},[t,i("span",{className:"lu-topbar-sep"}),n]);return document.body.appendChild(o),o._count=e,o._countWrap=n,o}function hr(){const t=i("button",{id:"lu-lightbox-close",type:"button","aria-label":"닫기",text:"×"}),e=i("div",{className:"lu-lightbox-stage"}),n=i("div",{className:"lu-lightbox-title"}),o=i("div",{className:"lu-lightbox-meta"}),a=i("div",{className:"lu-lightbox-rule"}),u=i("div",{className:"lu-lightbox-desc"}),r=i("div",{className:"lu-lightbox-caption"},[n,o,a,u]),l=i("div",{id:"lu-lightbox",className:"lu"},[t,e,r]);document.body.appendChild(l),t.addEventListener("click",()=>Ne()),l.addEventListener("click",E=>{(E.target===l||E.target===e)&&Ne()});const s=new Map;let d=1,m=0,x=0,g=0,h=1,c=0,p=0,w=0,f=null;function C(){return e.querySelector(".lu-lightbox-media")}function L(){const E=C();E&&(E.style.transform=`translate(${m}px, ${x}px) scale(${d})`)}function k(){d=1,m=0,x=0,L()}l.addEventListener("pointerdown",E=>{if(s.set(E.pointerId,{x:E.clientX,y:E.clientY}),s.size===1&&(f={x:E.clientX,y:E.clientY,t:performance.now()}),s.size===2){const[v,b]=[...s.values()];g=Math.hypot(v.x-b.x,v.y-b.y),h=d}}),l.addEventListener("pointermove",E=>{const v=s.get(E.pointerId);if(!v)return;const b=E.clientX-v.x,B=E.clientY-v.y;if(v.x=E.clientX,v.y=E.clientY,s.size===2&&g>0){const[A,F]=[...s.values()];d=Math.min(4,Math.max(1,h*(Math.hypot(A.x-F.x,A.y-F.y)/g))),d===1&&(m=0,x=0),L()}else s.size===1&&d>1&&(m+=b,x+=B,L())});function T(E){if(s.delete(E.pointerId),s.size!==0||!f)return;const v=performance.now()-f.t,b=E.clientX-f.x,B=E.clientY-f.y;if(f=null,d===1&&v<600){if(Math.abs(b)>64&&Math.abs(B)<56){gr(b<0?1:-1);return}if(B>84&&Math.abs(b)<60){Ne();return}}if(Math.abs(b)<12&&Math.abs(B)<12&&v<350){const A=performance.now();if(A-c<320&&Math.hypot(E.clientX-p,E.clientY-w)<44){d>1?k():(d=2.4,L()),c=0;return}c=A,p=E.clientX,w=E.clientY}}return l.addEventListener("pointerup",T),l.addEventListener("pointercancel",E=>s.delete(E.pointerId)),{overlay:l,closeBtn:t,stage:e,title:n,meta:o,rule:a,desc:u,resetZoom:k}}let bo=null;function gr(t){const e=Re();if(!bo||e.length<2)return;const n=e.indexOf(bo),o=e[((n===-1?0:n)+t+e.length)%e.length];Vn(o)}const Jo="data:image/svg+xml;utf8,"+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="56" height="56"><rect width="56" height="56" fill="#eaeae6"/></svg>');function Hn(t){const e=y.artworkList.body;if(e.innerHTML="",!Array.isArray(t)||t.length===0){e.appendChild(i("div",{className:"lu-artlist-empty",text:"표시할 작품이 없습니다"}));return}t.forEach(n=>{const o=i("img",{className:"lu-artlist-thumb",src:n.imageUrl||Jo,alt:n.title||"",loading:"lazy"});o.addEventListener("error",()=>{o.src=Jo},{once:!0});const a=i("div",{className:"lu-artlist-info"},[i("div",{className:"lu-artlist-name",text:n.title||""}),i("div",{className:"lu-artlist-artist",text:n.artist||""})]),u=i("button",{type:"button",className:"lu-artlist-card"},[o,a]);u.addEventListener("click",()=>{pe(),typeof ho=="function"&&ho(n)}),e.appendChild(u)})}function br(){const t=i("button",{id:"lu-artlist-close",type:"button","aria-label":"닫기",text:"×"}),e=i("div",{id:"lu-artlist-head"},[i("div",{id:"lu-artlist-title",text:"작품 목록"}),t]),n=i("div",{id:"lu-artlist-body"}),o=i("div",{id:"lu-artlist",className:"lu"},[e,n]);return document.body.appendChild(o),t.addEventListener("click",()=>pe()),{panel:o,body:n}}function mr(t){const e=Date.now(),n=Math.max(0,e-t),o=Math.floor(n/6e4);if(o<1)return"방금 전";if(o<60)return`${o}분 전`;const a=Math.floor(o/60);if(a<24)return`${a}시간 전`;const u=new Date(t),r=new Date(e),l=g=>new Date(g.getFullYear(),g.getMonth(),g.getDate()).getTime();if(Math.round((l(r)-l(u))/864e5)<=1)return"어제";const d=u.getFullYear(),m=String(u.getMonth()+1).padStart(2,"0"),x=String(u.getDate()).padStart(2,"0");return`${d}.${m}.${x}`}function Xn(t){const e=y.guestbook.body;if(e.innerHTML="",!Array.isArray(t)||t.length===0){e.appendChild(i("div",{className:"lu-gbook-empty",text:"첫 방명록을 남겨보세요"}));return}const n=["#e07a5f","#81b29a","#5f9e7d","#8e7dbe","#6a8caf","#d68fb8"];t.forEach(o=>{const a=o.name||"게스트";let u=0;for(let d=0;d<a.length;d++)u=u*31+a.charCodeAt(d)>>>0;const r=i("span",{className:"lu-gbook-dot"});r.style.background=n[u%n.length];const l=i("div",{},[r,i("span",{className:"lu-gbook-name",text:a}),i("span",{className:"lu-gbook-time",text:mr(o.ts)})]),s=i("div",{className:"lu-gbook-text",text:o.text||""});e.appendChild(i("div",{className:"lu-gbook-note"},[l,s]))})}function xr(){const t=i("button",{id:"lu-guestbook-close",type:"button","aria-label":"닫기",text:"×"}),e=i("div",{id:"lu-guestbook-head"},[i("div",{id:"lu-guestbook-title"},[i("span",{className:"lu-gb-eyebrow",text:"GUESTBOOK"}),i("span",{className:"lu-gb-main",text:"방명록"}),i("span",{className:"lu-gb-sub",text:"다녀간 마음을 한 줄 남겨 주세요"})]),t]),n=i("div",{id:"lu-guestbook-body"}),o=i("textarea",{id:"lu-gbook-input",rows:"3",maxlength:String(ke),placeholder:"전시에 한 줄 메모를 남겨보세요…",spellcheck:"false"}),a=i("span",{className:"lu-gbook-count",text:`0/${ke}`}),u=i("button",{id:"lu-gbook-submit",type:"button",text:"남기기"});u.disabled=!0;const r=i("div",{className:"lu-gbook-footer-row"},[a,u]),l=i("div",{id:"lu-gbook-stats",style:"font-size:11px;letter-spacing:0.04em;color:rgba(255,255,255,0.45);padding:6px 2px 0;"}),s=i("div",{id:"lu-guestbook-footer"},[o,r,l]),d=i("button",{id:"lu-gbtab",type:"button","aria-label":"방명록 열기/닫기 (위아래로 드래그해 위치 이동)",title:"드래그해서 위치를 옮길 수 있어요",text:"방명록"}),m="lu-gbtab-top-v1";try{const f=parseFloat(localStorage.getItem(m)??"");Number.isFinite(f)&&(d.style.top=x(f)+"px")}catch{}function x(f){const C=Math.max(80,(window.innerHeight||800)-140);return Math.min(C,Math.max(60,f))}let g=null;d.addEventListener("pointerdown",f=>{const C=d.getBoundingClientRect();g={startY:f.clientY,startTop:C.top,moved:!1},d.setPointerCapture(f.pointerId)}),d.addEventListener("pointermove",f=>{if(!g)return;const C=f.clientY-g.startY;Math.abs(C)>6&&(g.moved=!0),g.moved&&(d.style.top=x(g.startTop+C)+"px")});const h=()=>{if(g&&g.moved)try{localStorage.setItem(m,String(parseFloat(d.style.top)))}catch{}setTimeout(()=>{g=null},0)};d.addEventListener("pointerup",h),d.addEventListener("pointercancel",h),d.addEventListener("click",()=>{g&&g.moved||xo()});const c=i("div",{id:"lu-guestbook",className:"lu"},[e,n,s,d]);document.body.appendChild(c),t.addEventListener("click",()=>Ao());function p(){const f=o.value.length;a.textContent=`${f}/${ke}`,u.disabled=o.value.trim().length===0}function w(){const f=o.value.trim().slice(0,ke);f&&(o.value="",p(),o.blur(),typeof go=="function"&&go(f))}return o.addEventListener("keydown",f=>{f.stopPropagation(),f.key==="Escape"?(o.value="",p(),o.blur()):f.key==="Enter"&&(f.ctrlKey||f.metaKey)&&(f.preventDefault(),w())}),o.addEventListener("keyup",f=>f.stopPropagation()),o.addEventListener("keypress",f=>f.stopPropagation()),o.addEventListener("input",p),u.addEventListener("click",w),{panel:c,body:n,input:o,count:a,submitBtn:u,tab:d}}function Br(){const t=i("button",{type:"button","aria-label":"이전 작품",text:"◀ 이전"}),e=i("span",{className:"lu-tour-sep"}),n=i("span",{className:"lu-tour-count"}),o=i("span",{className:"lu-tour-title"}),a=i("span",{className:"lu-tour-sep"}),u=i("button",{type:"button","aria-label":"다음 작품",text:"다음 ▶"}),r=i("span",{className:"lu-tour-sep"}),l=i("button",{type:"button",className:"lu-tour-auto"}),s=i("span",{className:"lu-tour-sep"}),d=i("button",{id:"lu-tourbar-exit",type:"button","aria-label":"투어 종료",text:"✕ 종료"}),m=i("div",{id:"lu-tourbar",className:"lu"},[t,e,n,o,a,u,r,l,s,d]);return document.body.appendChild(m),t.addEventListener("click",()=>{yt.onPrev&&yt.onPrev()}),u.addEventListener("click",()=>{yt.onNext&&yt.onNext()}),d.addEventListener("click",()=>{yt.onExit&&yt.onExit()}),l.addEventListener("click",()=>{yt.onToggleAuto&&yt.onToggleAuto()}),{bar:m,prevBtn:t,nextBtn:u,autoBtn:l,exitBtn:d,countEl:n,titleEl:o}}function wr(){const t=i("div",{id:"lu-shutter",className:"lu"});return document.body.appendChild(t),t}function yr(){const t=i("button",{id:"lu-share-close",type:"button","aria-label":"닫기",text:"×"}),e=i("div",{className:"lu-share-title",text:"전시 공유하기"}),n=i("img",{className:"lu-share-preview",alt:"캡처한 전시 화면"}),o=i("button",{className:"lu-share-btn lu-share-btn-primary",type:"button",text:"기기로 공유"}),a=i("button",{className:"lu-share-btn",type:"button",text:"이미지 저장"}),u=i("button",{className:"lu-share-btn",type:"button",text:"X에 공유"}),r=i("button",{className:"lu-share-btn",type:"button",text:"Threads에 공유"}),l=i("button",{className:"lu-share-btn",type:"button",text:"링크 복사"}),s=i("div",{className:"lu-share-actions"},[o,a,u,r,l]),d=i("div",{className:"lu-share-hint",text:"인스타그램은 이미지를 저장하거나 기기로 공유한 뒤 앱에서 올려주세요"}),m=i("div",{className:"lu-share-card"},[t,e,n,s,d]),x=i("div",{id:"lu-share",className:"lu"},[m]);return document.body.appendChild(x),t.addEventListener("click",()=>mo()),x.addEventListener("click",g=>{g.target===x&&mo()}),o.addEventListener("click",async()=>{if(!(!rt.blob||typeof navigator>"u"||typeof navigator.share!="function"))try{const g=new File([rt.blob],"artshow.png",{type:"image/png"});await navigator.share({files:[g],title:rt.galleryName||"OpenArtShow",text:`${rt.galleryName||"OpenArtShow"} — OpenArtShow 3D 전시`})}catch{}}),a.addEventListener("click",()=>{if(!rt.dataUrl)return;const g=document.createElement("a");g.href=rt.dataUrl,g.download="artshow.png",document.body.appendChild(g),g.click(),document.body.removeChild(g)}),u.addEventListener("click",()=>{const g=`${rt.galleryName||"OpenArtShow"} — OpenArtShow 3D 전시`,h=`https://twitter.com/intent/tweet?text=${encodeURIComponent(g)}&url=${encodeURIComponent(rt.shareUrl||"")}`;window.open(h,"_blank","noopener")}),r.addEventListener("click",()=>{const g=`${rt.galleryName||"OpenArtShow"} — OpenArtShow 3D 전시 ${rt.shareUrl||""}`,h=`https://www.threads.net/intent/post?text=${encodeURIComponent(g)}`;window.open(h,"_blank","noopener")}),l.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(rt.shareUrl||""),Pt&&clearTimeout(Pt),l.textContent="복사됨",l.classList.add("lu-share-btn-copied"),Pt=setTimeout(()=>{l.textContent="링크 복사",l.classList.remove("lu-share-btn-copied"),Pt=null},1600)}catch{}}),{overlay:x,card:m,title:e,preview:n,deviceBtn:o,saveBtn:a,xBtn:u,threadsBtn:r,copyBtn:l}}function vo(){!y||!y.chibiMaker||qt.chibiOpen||Ht||jt||Yt||Xt||y.chibiMaker.open()}function Dr(){y&&y.chibiMaker&&y.chibiMaker.close()}function vr(){window.addEventListener("keydown",t=>{if(t.key==="Escape"){if(qt.chibiOpen){t.preventDefault(),t.stopImmediatePropagation(),Dr();return}if(jt){t.preventDefault(),t.stopImmediatePropagation(),mo();return}if(Ht){t.preventDefault(),t.stopImmediatePropagation(),Ne();return}if(Xt){t.preventDefault(),t.stopImmediatePropagation(),pe();return}if(Yt){t.preventDefault(),t.stopImmediatePropagation(),Ao();return}return}if(Ht||jt||!qt.entered)return;const e=document.activeElement;e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA")||(t.key==="Enter"?(t.preventDefault(),t.stopPropagation(),y.chat.input.focus()):(t.key==="c"||t.key==="C"||t.key==="ㅊ")&&!qt.chibiOpen&&(t.preventDefault(),t.stopPropagation(),vo()))})}function Ar({onEnter:t,onChatSend:e,onAvatarChange:n,onMakerToggle:o}={}){if(Zo){tt.onEnter=t||tt.onEnter,tt.onChatSend=e||tt.onChatSend,tt.onAvatarChange=n||tt.onAvatarChange,tt.onMakerToggle=o||tt.onMakerToggle;return}Zo=!0,tt.onEnter=t||null,tt.onChatSend=e||null,tt.onAvatarChange=n||null,tt.onMakerToggle=o||null,Uu(),y={loading:rr(),lobby:ir(),controls:sr(),topRight:cr(),status:dr(),chat:pr(),artwork:Cr(),galleryTitle:fr(),lightbox:hr(),artworkList:br(),guestbook:xr(),tourBar:Br(),dock:lr(),shutter:wr(),share:yr()},y.chibiMaker=ar({els:y,state:qt,callbacks:tt,setStatus:st}),y.topRight.count=y.galleryTitle._count,y.topRight.countWrap=y.galleryTitle._countWrap,vr(),Xe!==null&&Un(Xe),Tt&&jn(Tt.galleries,Tt.currentId,Tt.onPick),Ye&&Hn(Ye),He&&Xn(He)}function Qo(t){y&&y.loading.classList.toggle("lu-hidden",!t)}function kr(){if(!y)return;qt.entered=!0,y.lobby.overlay.classList.add("lu-hidden"),y.controls.classList.add("lu-visible"),y.topRight.wrap.classList.add("lu-visible"),y.status.classList.add("lu-visible"),y.chat.wrap.classList.add("lu-visible"),y.galleryTitle.classList.add("lu-visible"),y.guestbook.tab.classList.add("lu-visible"),y.dock&&y.dock.classList.add("lu-visible");const t=document.getElementById("lu-controls-toggle");t&&t.classList.add("lu-visible")}function Er(t){!y||!t||Co===t.id&&y.artwork.panel.classList.contains("lu-open")||(Co=t.id,y.artwork.title.textContent=t.title||"",y.artwork.meta.textContent=[t.artist,t.year].filter(Boolean).join(" · "),y.artwork.desc.textContent=t.desc||"",y.artwork.panel.classList.add("lu-open"))}function Sr(){y&&(Co=null,y.artwork.panel.classList.remove("lu-open"))}function Yn(t,e,n){if(!y)return;const o=i("div",{className:"lu-chat-msg"+(n?" lu-self":"")},[i("span",{className:"lu-chat-name",text:t}),i("span",{text:e})]);for(y.chat.log.appendChild(o);y.chat.log.children.length>ur;)y.chat.log.removeChild(y.chat.log.firstChild)}function Mr(t){if(!y)return;const e=y.topRight.count.textContent;y.topRight.count.textContent=String(t),e!==String(t)&&y.topRight.countWrap&&(y.topRight.countWrap.classList.remove("lu-tick"),y.topRight.countWrap.offsetWidth,y.topRight.countWrap.classList.add("lu-tick")),Ot&&Ot.chatWrap&&(Ot.chatWrap.style.display=t>=2?"":"none")}function st(t){y&&(y.status.textContent=t||"")}function Tr(t){y&&(y.topRight.fps.textContent=String(Math.round(t)))}function Un(t){y.galleryTitle.querySelector(".lu-topbar-title").textContent=t||"",y.galleryTitle.classList.toggle("lu-empty",!t)}function Lr(t){Xe=t||"",y&&Un(Xe)}function jn(t,e,n){const o=y.lobby.pickerBox;if(o.innerHTML="",!Array.isArray(t)||t.length===0)return;const a=i("div",{className:"lu-field-label",text:"전시 선택",style:"margin-top:26px;"});o.appendChild(a),e==null&&o.appendChild(i("div",{className:"lu-picker-note",text:"공유된 전시 관람 중"}));const u=i("div",{className:"lu-picker-list"});t.forEach(r=>{const l=r.id===e,s=i("button",{type:"button",className:"lu-picker-item"+(l?" lu-picker-current":"")},[i("div",{className:"lu-picker-name",text:r.name||r.id}),i("div",{className:"lu-picker-meta",text:[r.artist,typeof r.count=="number"?`${r.count}점`:null].filter(Boolean).join(" · ")})]);l&&(s.disabled=!0),s.addEventListener("click",()=>{l||typeof n=="function"&&n(r.id)}),u.appendChild(s)}),o.appendChild(u)}function zr(t,e,n){Tt={galleries:t,currentId:e??null,onPick:n},y&&jn(Tt.galleries,Tt.currentId,Tt.onPick)}function $n(){const t=y.lightbox.stage,e=t.firstChild;e&&e.tagName==="VIDEO"&&(e.pause(),e.removeAttribute("src"),e.load()),t.innerHTML=""}function Vn(t){if(!y||!t)return;bo=t,y.lightbox.resetZoom&&y.lightbox.resetZoom(),Rt&&(clearTimeout(Rt),Rt=null),$n();let e;t.videoUrl?(e=i("video",{className:"lu-lightbox-media",src:t.videoUrl,controls:"controls",autoplay:"autoplay",loop:"loop",muted:"muted",playsinline:"playsinline"}),e.muted=!0):e=i("img",{className:"lu-lightbox-media",src:t.imageUrl||"",alt:t.title||""}),y.lightbox.stage.appendChild(e),y.lightbox.title.textContent=t.title||"",y.lightbox.meta.textContent=[t.artist,t.year].filter(Boolean).join(" · "),y.lightbox.desc.textContent=t.desc||"",Ht=!0,y.lightbox.overlay.classList.add("lu-open")}function Ne(){!y||!Ht||(Ht=!1,y.lightbox.overlay.classList.remove("lu-open"),Rt&&clearTimeout(Rt),Rt=setTimeout(()=>{$n(),Rt=null},340),typeof fo=="function"&&fo())}function ie(){return Ht}function _r(t){fo=typeof t=="function"?t:null}function Fr(t,e){ho=typeof e=="function"?e:null,Ye=t,y&&Hn(Ye)}function Wn(){y&&(Xt?pe():(Xt=!0,y.artworkList.panel.classList.add("lu-open")))}function pe(){!y||!Xt||(Xt=!1,y.artworkList.panel.classList.remove("lu-open"))}function tn(){return Xt}function Nr({index:t,total:e,title:n,autoOn:o}={}){if(!y)return;const a=y.tourBar,u=Number.isFinite(t)?t+1:1,r=Number.isFinite(e)?e:0;a.countEl.textContent=`● ${u} / ${r}`,a.titleEl.textContent=` — ${n||""}`,a.autoBtn.textContent=o?"자동진행 ON":"자동진행 OFF",a.autoBtn.classList.toggle("lu-tour-on",!!o),a.bar.classList.add("lu-open")}function Ir(){y&&y.tourBar.bar.classList.remove("lu-open")}function Rr({onTour:t,onViewArtwork:e,onGuestbook:n,onCapture:o,onSelfView:a}={}){bt={onTour:typeof t=="function"?t:null,onViewArtwork:typeof e=="function"?e:null,onGuestbook:typeof n=="function"?n:null,onCapture:typeof o=="function"?o:null,onSelfView:typeof a=="function"?a:null}}function Pr({blob:t,dataUrl:e,galleryName:n,shareUrl:o}={}){if(!y)return;rt={blob:t||null,dataUrl:e||"",galleryName:n||"",shareUrl:o||(typeof window<"u"?window.location.href:"")},y.share.preview.src=rt.dataUrl;let a=!1;if(rt.blob&&typeof navigator<"u"&&typeof navigator.share=="function"&&typeof navigator.canShare=="function")try{const u=new File([rt.blob],"artshow.png",{type:"image/png"});a=navigator.canShare({files:[u]})}catch{a=!1}y.share.deviceBtn.style.display=a?"":"none",Pt&&(clearTimeout(Pt),Pt=null),y.share.copyBtn.textContent="링크 복사",y.share.copyBtn.classList.remove("lu-share-btn-copied"),jt=!0,y.share.overlay.classList.add("lu-open")}function mo(){!y||!jt||(jt=!1,y.share.overlay.classList.remove("lu-open"))}function no(){return jt}function en(){if(!y)return;const t=y.shutter;t.style.transition="none",t.style.opacity="1",t.offsetWidth,t.style.transition="opacity 0.25s ease",t.style.opacity="0"}function Or({onPrev:t,onNext:e,onExit:n,onToggleAuto:o}={}){yt={onPrev:typeof t=="function"?t:null,onNext:typeof e=="function"?e:null,onExit:typeof n=="function"?n:null,onToggleAuto:typeof o=="function"?o:null}}function Gr(t){const e=document.getElementById("lu-gbook-stats");e&&(e.textContent=t||"")}function Hr({onSubmit:t}={}){go=typeof t=="function"?t:null}function xo(){y&&(Yt?Ao():(Yt=!0,y.guestbook.panel.classList.add("lu-open")))}function Ao(){!y||!Yt||(Yt=!1,y.guestbook.panel.classList.remove("lu-open"))}function Xr(){return Yt}function ko(t){He=Array.isArray(t)?t:[],y&&Xn(He)}function Yr(t){return t<.5?4*t*t*t:1-Math.pow(-2*t+2,3)/2}function Ur(t,e,n){let o=(e-t)%(Math.PI*2);return o>Math.PI&&(o-=Math.PI*2),o<-Math.PI&&(o+=Math.PI*2),t+o*n}function jr(t){if(t!=="auto")return t;const e=new Date().getHours();return e>=6&&e<16?"daylight":e>=16&&e<19?"sunset":"night"}function $r(t){let e=5381;for(let n=0;n<t.length;n++)e=(e<<5)+e+t.charCodeAt(n)>>>0;return e.toString(36)}function Vr(t){function e(a){if(a.code==="KeyE"){t.viewCurrentArtwork();return}if(a.code==="KeyM"){if(!t.isEntered()||t.isLightboxOpen())return;t.toggleArtworkList();return}if(a.code==="KeyT"){if(!t.isEntered())return;t.toggleTour();return}if(a.code==="KeyG"){if(!t.isEntered()||t.isLightboxOpen())return;t.toggleGuestbook();return}if(a.code==="KeyP"){if(!t.isEntered()||t.isShareModalOpen())return;t.flashShutter(),t.capturePhoto();return}if(a.code==="KeyV"){if(!t.isEntered()||t.isShareModalOpen())return;t.toggleSelfView();return}if(t.isTouring()&&(a.code==="ArrowLeft"||a.code==="ArrowRight")){if(t.isLightboxOpen())return;a.preventDefault(),a.code==="ArrowLeft"?t.tourPrev():t.tourNext();return}a.code==="Escape"&&t.isTouring()&&!t.isLightboxOpen()&&!t.isArtworkListOpen()&&!t.isGuestbookOpen()&&t.exitTour()}function n(){const a=t.getCamera(),u=t.getRenderer();a.aspect=window.innerWidth/window.innerHeight,a.updateProjectionMatrix(),u.setSize(window.innerWidth,window.innerHeight)}function o(){const a=t.getMp();if(a)try{a.dispose()}catch{}}return{onKeyDown:e,onWindowResize:n,onBeforeUnload:o}}function Wr(t){const e=t.split(",")[1],n=atob(e),o=new Uint8Array(n.length);for(let a=0;a<n.length;a++)o[a]=n.charCodeAt(a);return new Blob([o],{type:"image/png"})}function Kr(t,e,n,o){const a=Math.max(90,Math.round(n*.14)),u=t.createLinearGradient(0,n-a,0,n);u.addColorStop(0,"rgba(0,0,0,0)"),u.addColorStop(1,"rgba(0,0,0,0.55)"),t.fillStyle=u,t.fillRect(0,n-a,e,a);const r=Math.max(20,Math.round(e*.025)),l=Math.max(1,e/1400);t.textBaseline="alphabetic",t.textAlign="left",t.fillStyle="rgba(255,255,255,0.95)",t.font=`300 ${Math.round(18*l)}px ${ue()}`,t.fillText(o||"OpenArtShow 전시",r,n-r-6*l),t.fillStyle="#5f9e7d",t.font=`300 ${Math.round(16*l)}px ${ue()}`,Zr(t,"OpenArtShow",e-r,n-r-22*l,2.5*l),t.textAlign="right",t.fillStyle="rgba(255,255,255,0.6)",t.font=`300 ${Math.round(12*l)}px ${ue()}`,t.fillText("syhongart.github.io/openartshow",e-r,n-r-4*l)}function Zr(t,e,n,o,a){const u=Array.from(e),r=u.map(m=>t.measureText(m).width),l=r.reduce((m,x)=>m+x,0)+a*(u.length-1),s=t.textAlign;t.textAlign="left";let d=n-l;u.forEach((m,x)=>{t.fillText(m,d,o),d+=r[x]+a}),t.textAlign=s}function qr(){const t=window.location.href;return t.length<2e3?t:window.location.origin+window.location.pathname.replace(/index\.html$/,"landing.html")}function Jr(t){const{getRenderer:e,getScene:n,getCamera:o,isThirdPerson:a,getSelfAvatar:u,applySelfCamOffset:r,restoreSelfCamOffset:l,getGalleryInfo:s,photoWall:d,getMyNickname:m,getMp:x,showShareModal:g,setStatus:h}=t;function c(){const p=e(),w=n(),f=o();if(!(!p||!w||!f))try{a()&&u()&&r(),p.render(w,f),a()&&u()&&l();const C=p.domElement.toDataURL("image/png"),L=new Image;L.onload=()=>{const k=document.createElement("canvas");k.width=L.width,k.height=L.height;const T=k.getContext("2d");if(!T)return;T.drawImage(L,0,0);const E=T.createRadialGradient(k.width/2,k.height*.46,Math.min(k.width,k.height)*.4,k.width/2,k.height*.46,Math.max(k.width,k.height)*.72);E.addColorStop(0,"rgba(8,6,4,0)"),E.addColorStop(.24,"rgba(8,6,4,0.03)"),E.addColorStop(.44,"rgba(8,6,4,0.09)"),E.addColorStop(.64,"rgba(8,6,4,0.17)"),E.addColorStop(.82,"rgba(8,6,4,0.26)"),E.addColorStop(1,"rgba(8,6,4,0.34)"),T.fillStyle=E,T.fillRect(0,0,k.width,k.height),Kr(T,k.width,k.height,s()?s().name:"");const v=k.toDataURL("image/png");try{const B=Math.round(k.height/k.width*360),A=document.createElement("canvas");A.width=360,A.height=B;const F=A.getContext("2d");if(!F)throw new Error("썸네일 2D 컨텍스트를 얻지 못했습니다");F.drawImage(k,0,0,360,B);const M=A.toDataURL("image/jpeg",.72),R=d.addLocal(m(),s()?s().name:"",M);R&&x()&&x().sendPhoto(R)}catch(b){console.warn("포토월 썸네일 생성 실패 (캡처 자체는 정상):",b)}g({blob:Wr(v),dataUrl:v,galleryName:s()&&s().name||"OpenArtShow 전시",shareUrl:qr()})},L.onerror=()=>{h("사진 촬영에 실패했습니다.")},L.src=C}catch(C){console.error("사진 촬영 실패:",C),h("사진 촬영에 실패했습니다.")}}return{capturePhoto:c}}function Qr(t){const{getPlacedArtworks:e,getPlayer:n,isEntered:o,getTween:a,clearTween:u,startTween:r,getViewingPose:l,showTourBar:s,hideTourBar:d,setDockActive:m,isLightboxOpen:x,isArtworkListOpen:g,hideArtworkList:h}=t;let c=!1,p=0,w=!0,f=!1,C=0;const L=6;function k(D){s({index:p,total:e().length,title:D&&D.title||"",autoOn:w})}function T(D){const _=e()[D];if(!_)return;p=D,f=!1,C=0,k(_);const X=l(_);r(X,()=>{n().setPose(X),f=!0,C=0})}function E(){if(!o()||x()||c)return;const D=e();!D||D.length===0||(g()&&h(),c=!0,m("tour",!0),w=!0,n().disable(),T(0))}function v(){if(!c)return;c=!1,m("tour",!1),f=!1,u(),d();const D=n(),_=D.getState();D.setPose({x:_.x,z:_.z,ry:_.ry}),o()&&!x()&&D.enable()}function b(){c?v():E()}function B(){const D=e();!c||D.length===0||T((p+1)%D.length)}function A(){const D=e();!c||D.length===0||T((p-1+D.length)%D.length)}function F(){c&&(w=!w,C=0,k(e()[p]))}function M(D){const _=e().indexOf(D);_!==-1&&(p=_),f=!1}function R(D){k(D),f=!0,C=0}function S(D){c&&f&&w&&!a()&&!x()&&(C+=D,C>=L&&B())}return{tick:S,startTour:E,exitTour:v,toggleTour:b,next:B,prev:A,toggleAuto:F,syncOnSelect:M,onArrive:R,isTouring:()=>c,getIndex:()=>p}}function ti(t){const{getScene:e,getCamera:n,getPlayer:o,getSelfInfo:a,isEntered:u,createAvatarInstance:r,EYE_HEIGHT:l,setStatus:s,setDockActive:d}=t,m=3,x=.7,g=-.2;let h=!1,c=null,p=null,w=0;const f=new No,C=new No,L=new tu;function k(){if(u())if(h=!h,h){const B=a();if(!c&&B)try{c=r(B.char,B.color," "),c.group.traverse(A=>{A.isSprite&&(A.visible=!1)}),e().add(c.group)}catch(A){console.warn("내 아바타 생성 실패:",A),c=null,h=!1;return}if(!c){h=!1;return}c.group.visible=!0,d("self",!0),p=null,w=0,s("내 모습 보기 — V키 또는 [시점] 버튼으로 복귀")}else c&&(c.group.visible=!1,d("self",!1))}function T(B){if(!c)return;const A=c.group,F=A.visible,M=A.position.clone(),R=A.rotation.y;try{const S=a(),D=r(B,S&&S.color||"#3498db"," ");D.group.traverse(_=>{_.isSprite&&(_.visible=!1)}),D.group.position.copy(M),D.group.rotation.y=R,D.group.visible=F,e().add(D.group),e().remove(A),c.dispose(),c=D}catch(S){console.warn("내 아바타 갱신 실패:",S)}}function E(){const B=n();f.copy(B.position),L.copy(B.quaternion),C.set(0,0,1).applyQuaternion(B.quaternion),B.position.addScaledVector(C,m),B.position.y+=x,B.rotateX(g)}function v(){const B=n();B.position.copy(f),B.quaternion.copy(L)}function b(B){if(h&&c){const A=o().getState();c.group.position.set(A.x,A.y-l,A.z),c.group.rotation.y=A.ry,p||(p={x:A.x,z:A.z});const F=B>0?Math.hypot(A.x-p.x,A.z-p.z)/B:0;w+=(F-w)*Math.min(1,10*B),p.x=A.x,p.z=A.z,c.update(B,w)}}return{tick:b,toggle:k,rebuildAvatar:T,applySelfCamOffset:E,restoreSelfCamOffset:v,isThirdPerson:()=>h,getSelfAvatar:()=>c,getSelfCamDist:()=>m}}function ei(t){const{getScene:e,getPlayer:n,setStatus:o,getGuestbookNotes:a,onVisitor:u,onPhoto:r,onChat:l,onPlayerCount:s,onRemoteGuestbook:d,onSelfHit:m,onNpcHit:x,npcProvider:g}=t;let h=null,c=!1;function p(L){if(o(L),!(c||!h)&&(L==="호스트로 개설됨"||L.startsWith("접속됨"))){c=!0;try{h.sendGuestbook(a())}catch(k){console.error("방명록 동기화 전송 실패:",k)}}}function w({nickname:L,color:k,char:T,roomId:E}){try{return h=new va(e(),{nickname:L,color:k,char:T,roomId:E}),h.onVisitor=(v,b)=>u(v,b),h.onPhoto=v=>r(v),h.onChat=(v,b)=>l(v,b),h.onPlayerCount=v=>s(v),h.onStatus=p,h.onGuestbook=v=>d(v),h.onSelfHit=v=>m(v),h.onNpcHit=(v,b,B)=>x(v,b,B),h.npcProvider=(v,b)=>g(v,b),h.connect(),!0}catch(v){return console.error("멀티플레이어 초기화 실패:",v),h=null,!1}}function f(L){h&&(h.sendState(n().getState()),h.update(L))}function C(){return h}return{connect:w,tick:f,getMp:C}}const ao=typeof matchMedia=="function"&&matchMedia("(pointer: coarse)").matches;function oi(t){const{renderer:e,camera:n,gpuInfo:o,getMp:a,isEntered:u,setFPS:r,setStatus:l}=t;let s=!1,d=0,m=0,x=0,g=0,h=!1,c=0,p=0,w=0;function f(){const k=a();if(!k)return;const T=[];for(const[E,v]of k.remoteAvatars)E.startsWith("npc-")&&T.push(v);if(!s){for(const E of T)E.group.visible=!0;return}T.sort((E,v)=>E.group.position.distanceTo(n.position)-v.group.position.distanceTo(n.position)),T.forEach((E,v)=>{E.group.visible=v<Ea})}function C(k){x=k}function L(k){const T=u();if(p+=1,w+=k,w>=.5){const E=p/w;if(r(Math.round(E)),p=0,w=0,d=Math.max(0,d-.5),d===0&&T){if(!s&&E<Aa){s=!0,d=10,E<16&&Je("low");const v=window.devicePixelRatio||1,b=ao?bn:Math.max(1,v*.75);e.setPixelRatio(Math.min(e.getPixelRatio(),b)),l("원활한 관람을 위해 화질을 잠시 낮췄어요")}else s&&E>ka&&(s=!1,d=10,f());if(!s&&E>55){if(c+=1,c>=20){const v=ze();v==="low"?Je(null):v===null&&!ao&&Je("high");const b=Math.min(2.5,Math.sqrt(_e.high/(window.innerWidth*window.innerHeight))),B=e.getPixelRatio();!o.soft&&!ao&&B<b&&(e.setPixelRatio(Math.min(b,B+.25)),l("화질을 한 단계 높였어요 ✨")),c=0}}else c=0}}m+=k,m>=2&&(m=0,s&&f()),x>0&&(g+=k,g>=x&&(g=0,e.shadowMap.needsUpdate=!0)),!h&&T&&(h=!0,e.shadowMap.needsUpdate=!0)}return{tick:L,setShadowInterval:C,getLite:()=>s}}function ni(t){const{camera:e,player:n,isEntered:o,setStatus:a}=t;let u=null;const r=.8,l=2.2,s=new Tn(0,0,0,"YXZ");function d(v,b){const B=n.getState(),A=typeof v.y=="number"?v.y:B.y,F=v.x-B.x,M=A-B.y,R=v.z-B.z,S=Math.hypot(F,M,R),D=gt.clamp(r+S*.035,r,l);n.disable(),u={fromX:B.x,fromY:B.y,fromZ:B.z,fromRy:B.ry,toX:v.x,toY:A,toZ:v.z,toRy:v.ry,duration:D,elapsed:0,onDone:b||null}}function m(v){if(!u)return;u.elapsed+=v;const b=Math.min(1,u.elapsed/u.duration),B=Yr(b),A=u.fromX+(u.toX-u.fromX)*B,F=u.fromY+(u.toY-u.fromY)*B,M=u.fromZ+(u.toZ-u.fromZ)*B,R=Ur(u.fromRy,u.toRy,B);if(e.position.set(A,F,M),s.set(0,R,0,"YXZ"),e.quaternion.setFromEuler(s),b>=1){const S=u.onDone;u=null,S&&S()}}function x(){return u}function g(){u=null}let h=null;function c(){if(!o())return;const v=e.position.y-vt;let b=null;for(const B of I.floors)v>=B.y-.9&&(b===null||B.y>b.y)&&(b=B);if(b){if(h===null){h=b.id;return}b.id!==h&&(h=b.id,a(b.name))}}const p="lu-onboard-v1";let w=-1,f=null,C=null,L=0,k=0;function T(){try{if(localStorage.getItem(p))return}catch{}if(!(typeof matchMedia=="function"&&matchMedia("(pointer: coarse)").matches))return;w=0;const v=n.getState();C={x:v.x,z:v.z};const b=document.createElement("style");b.textContent="@keyframes lu-ob-pulse { 0%{transform:translate(-50%,-50%) scale(1);opacity:0.75;} 70%{transform:translate(-50%,-50%) scale(1.25);opacity:0.2;} 100%{transform:translate(-50%,-50%) scale(1);opacity:0.75;} }",document.head.appendChild(b),f=document.createElement("div"),f.style.cssText="position:fixed;left:24%;bottom:22%;width:110px;height:110px;border-radius:50%;border:3px solid rgba(255,253,247,0.85);pointer-events:none;z-index:60;transform:translate(-50%,-50%);animation:lu-ob-pulse 1.6s ease-in-out infinite;",document.body.appendChild(f),a("왼쪽 화면을 누른 채 밀면 걸어요 🚶")}function E(){if(w<0)return;const v=n.getState();if(w===0)Math.hypot(v.x-C.x,v.z-C.z)>1.5&&(w=1,L=v.ry,f&&(f.remove(),f=null),a("잘했어요! 오른쪽 화면을 쓸면 주위를 둘러봐요 👀"));else if(w===1){let b=v.ry-L;b=Math.atan2(Math.sin(b),Math.cos(b)),Math.abs(b)>.6&&(w=2,k=0,a("작품에 다가가면 설명이 나타나요 — 어려우면 [투어] 버튼을 눌러요 🖼️"))}else if(w===2&&(k+=1,k>420)){w=-1;try{localStorage.setItem(p,"1")}catch{}}}return{startTween:d,updateTween:m,getTween:x,clearTween:g,updateFloorIndicator:c,startOnboarding:T,tickOnboarding:E}}const ai="lu-stats-v1-",ui=3;function on(){const t=new Date;return`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`}function ri(){return{totalVisits:0,days:{},dwell:{}}}class ii{key;_seen;data;_saveTimer;constructor(e){this.key=ai+String(e||"default"),this._seen=new Set,this.data=ri();try{const n=localStorage.getItem(this.key);if(n){const o=JSON.parse(n);o&&typeof o=="object"&&(this.data={totalVisits:o.totalVisits|0,days:o.days&&typeof o.days=="object"?o.days:{},dwell:o.dwell&&typeof o.dwell=="object"?o.dwell:{}})}}catch{}this._saveTimer=null}_save(){this._saveTimer||(this._saveTimer=setTimeout(()=>{this._saveTimer=null;try{localStorage.setItem(this.key,JSON.stringify(this.data))}catch{}},2e3))}addVisit(e){if(!e||this._seen.has(e))return;this._seen.add(e),this.data.totalVisits+=1;const n=on();this.data.days[n]=(this.data.days[n]|0)+1;const o=Object.keys(this.data.days).sort();for(;o.length>60;)delete this.data.days[o.shift()];this._save()}addDwell(e,n,o){if(!e||!e.length||!n||!n.length)return;let a=!1;for(const u of e){let r=null,l=ui;for(const s of n){const d=Math.hypot(s.pos.x-u.x,s.pos.z-u.z);d<l&&(l=d,r=s)}r&&r.title&&(this.data.dwell[r.title]=(this.data.dwell[r.title]||0)+o,a=!0)}a&&this._save()}summary(e){const o=[`오늘 방문 ${this.data.days[on()]|0}`,`누적 ${this.data.totalVisits}`];typeof e=="number"&&o.push(`방명록 ${e}`);const a=Object.entries(this.data.dwell).sort((u,r)=>r[1]-u[1])[0];if(a&&a[1]>=10){const u=a[1]>=60?`${Math.round(a[1]/60)}분`:`${Math.round(a[1])}초`;o.push(`인기작 「${a[0]}」 ${u}`)}return o.join(" · ")}}function si(t){const{getMp:e,getGuestbookNotesLength:n,setGuestbookStats:o}=t;let a=null,u=null;function r(d){return d&&d.id||"link-"+$r(window.location.hash||"")}function l(d){a=new ii(d),u&&clearInterval(u),u=setInterval(()=>{const m=e();if(!m||!a)return;const x=[];for(const[g,h]of m.remoteAvatars)g.startsWith("npc-")||x.push({x:h.group.position.x,z:h.group.position.z});a.addDwell(x,Re(),2),o(a.summary(n()))},2e3)}function s(d){a?.addVisit(d)}return{computeRoomSuffix:r,begin:l,recordVisit:s}}function li(t){const{renderer:e,scene:n,camera:o,player:a,gpuInfo:u,flyController:r,tourController:l,multiplayerController:s,selfViewController:d,viewfxController:m,perfGovernor:x,sceneTick:g,getNearbyArtwork:h,showArtworkInfo:c,hideArtworkInfo:p,setStatus:w}=t;let f=null,C=0;function L(){let T=f.getDelta();if(u.soft){if(C+=T,C<.034)return;T=C,C=0}try{r&&r.update(T),a.update(T);const E=s.getMp();E&&a.resolveBodyCollisions(E.getAvatarPositions()),m.updateTween(T),l.tick(T),g(T),m.updateFloorIndicator(),s.tick(T),m.tickOnboarding(),d.tick(T);const v=h(o.position);v?c(v):p(),x.tick(T),d.isThirdPerson()&&d.getSelfAvatar()?(d.applySelfCamOffset(),e.render(n,o),d.restoreSelfCamOffset()):e.render(n,o)}catch(E){console.error("렌더 루프 오류:",E),e.setAnimationLoop(null),w("오류가 발생했습니다. 페이지를 새로고침해 주세요.")}}function k(){f=new eu,e.setAnimationLoop(L)}return{start:k}}let j=null,Bt=null,dt=null,ot=null,nn=null,pt=null,Ve=null,Kn=null,it=null,ht=null,Ee=null,Nt=null,Ue=null,Kt=null;const ci=new ru;let lt={name:"",soft:!1};function di(t,e){const n=document.createElement("div");n.id="lu-gpu-notice",n.style.cssText=`position:fixed;left:50%;bottom:18px;transform:translateX(-50%);z-index:1200;max-width:min(92vw,600px);background:linear-gradient(180deg,#fffdf8,#f6f1e4);color:#17140f;border:1px solid rgba(95,158,125,0.55);border-radius:14px;padding:14px 44px 14px 18px;box-shadow:0 12px 32px rgba(20,15,8,0.35);font:13px/1.75 ${ue()};`;const o="<b>이 브라우저에서 3D 그래픽 기능을 사용할 수 없습니다</b><br>";n.innerHTML=o+'<b>Chrome</b>: 설정 → 시스템(<b>chrome://settings/system</b>) → "그래픽 가속 사용" 켜기 → 다시 시작<br><b>Edge</b>: 설정 → 시스템 및 성능 → "그래픽 가속 사용" 켜기 + "효율 모드" 끄기<br><b>Firefox</b>: 설정 → 일반 → 성능 → "권장 성능 설정" 해제 → "하드웨어 가속 사용" 체크<br>그래도 느리면: 원격 데스크톱 여부 확인 · 그래픽 드라이버 업데이트 · Windows 설정 → 디스플레이 → 그래픽에서 브라우저를 "고성능" GPU로 지정 · 확장프로그램 없는 시크릿 창으로 접속해 비교';const a=document.createElement("button");a.type="button",a.setAttribute("aria-label","닫기"),a.textContent="×",a.style.cssText="position:absolute;top:8px;right:10px;width:26px;height:26px;border:none;background:none;font-size:18px;color:#8a8172;cursor:pointer;",a.addEventListener("click",()=>n.remove());const u=document.createElement("button");u.type="button",u.textContent="진단 정보 복사",u.style.cssText="display:inline-block;margin-top:8px;padding:5px 14px;border-radius:999px;border:1px solid rgba(95,158,125,0.5);background:rgba(95,158,125,0.12);color:#17140f;font:600 11px/1 inherit;cursor:pointer;",u.addEventListener("click",()=>{const r=JSON.stringify({renderer:t,ua:navigator.userAgent,dpr:window.devicePixelRatio,screen:screen.width+"x"+screen.height,cores:navigator.hardwareConcurrency||0,mem:navigator.deviceMemory||0});try{navigator.clipboard.writeText(r),u.textContent="복사됨!"}catch{}}),n.appendChild(u),n.appendChild(a),document.body.appendChild(n)}const an=new uu;let se=null;function un(){ht.toggle()}function pi(t){if(!t)return;se=se?Object.assign({},se,{char:t}):{char:t},ht.rebuildAvatar(t);const e=pt.getMp();e&&typeof e.setChar=="function"&&e.setChar(t),st("아야모 모습을 바꿨어요 ✨")}const Ci=7,oe=new ou,rn=new zt;let uo=null;function fi(t){t.addEventListener("pointerdown",e=>{e.isPrimary&&(uo={x:e.clientX,y:e.clientY,t:performance.now()})}),t.addEventListener("pointerup",e=>{const n=uo;uo=null;const o=pt.getMp();if(!n||!e.isPrimary||!nt||!o||performance.now()-n.t>450||Math.hypot(e.clientX-n.x,e.clientY-n.y)>7)return;const a=t.getBoundingClientRect();rn.set((e.clientX-a.left)/a.width*2-1,-((e.clientY-a.top)/a.height)*2+1),oe.setFromCamera(rn,dt),oe.far=Ci+ht.getSelfCamDist();const u=[...o.remoteAvatars.entries()];if(!u.length)return;const r=u.map(([,d])=>d.group),l=oe.intersectObjects(r,!0);if(l.length){let d=l[0].object;for(;d&&!r.includes(d);)d=d.parent;if(d){const[m]=u[r.indexOf(d)];o.sendHit(m);return}}oe.far=60;const s=oe.intersectObjects(_a(),!1);s.length&&s[0].object.userData.luArt&&Zn(s[0].object.userData.luArt)})}let We="게스트",nt=!1,St=null,Ie=[],je="shared",Ct=[];async function hi(){Qo(!0),Bt=new zn,dt=new _n(55,window.innerWidth/window.innerHeight,.1,1e3),dt.position.set(I.spawn.x,vt,I.spawn.z);const t=typeof matchMedia=="function"&&matchMedia("(pointer: coarse)").matches,e=ze();lt=cu(),console.info("[OpenArtShow] GPU:",lt.name||"(unknown)",lt.soft?"— SOFTWARE RENDERING":"");try{j=new fn({antialias:!lt.soft,powerPreference:"high-performance"})}catch(c){throw di(""),c}fi(j.domElement);const n=document.createElement("div");n.id="lu-vignette",n.style.cssText="position:fixed;inset:0;pointer-events:none;z-index:5;background:radial-gradient(ellipse 72% 62% at 50% 46%, rgba(8,6,4,0) 50%, rgba(8,6,4,0.03) 62%, rgba(8,6,4,0.09) 72%, rgba(8,6,4,0.17) 82%, rgba(8,6,4,0.26) 91%, rgba(8,6,4,0.34) 100%);",document.body.appendChild(n);const o=window.devicePixelRatio||1;let a;e==="low"?a=Math.min(o,1.25):e==="high"?a=Math.min(Math.max(o,2),2.5):t?a=Math.min(o,2):a=Math.min(Math.max(o,1.5),2);const u=e==="high"?_e.high:e==="low"?_e.low:_e.base;a=Math.min(a,Math.sqrt(u/(window.innerWidth*window.innerHeight))),t&&(a=Math.min(a,bn)),lt.soft&&(a=Math.min(a,.7),document.documentElement.classList.add("lu-potato")),j.setPixelRatio(a),j.setSize(window.innerWidth,window.innerHeight),j.shadowMap.enabled=!lt.soft,j.shadowMap.type=nu,j.toneMapping=lt.soft?Ln:au,j.toneMappingExposure=.92,j.outputColorSpace=Lt,document.body.appendChild(j.domElement);const r=await Sa(),l=jr(r.theme);Eu(Bt,l,{fullLights:!lt.soft&&e!=="low"}),await Ma(),await Ta(Bt),window.__museum={scene:Bt,camera:dt,renderer:j},lt.soft&&(Bt.fog=null),j.shadowMap.autoUpdate=!1,j.shadowMap.needsUpdate=!0,St=r,Lr(St.name),gi(),je=r.id??"shared",Ct=La(je),ko(Ct),Hr({onSubmit:Bi}),Ie=Re(),Fr(Ie,Zn),Or({onPrev:Cn,onNext:pn,onExit:cn,onToggleAuto:mi}),Rr({onSelfView:()=>{nt&&!no()&&un()},onTour:()=>{nt&&dn()},onViewArtwork:sn,onGuestbook:()=>{nt&&!ie()&&xo()},onCapture:()=>{nt&&!no()&&(en(),ln())}}),ot=new Ou(dt,j.domElement);const s=I.floors.find(c=>c.id===I.spawn.floor);ot.setPose({x:I.spawn.x,y:(s?s.y:0)+vt,z:I.spawn.z,ry:I.spawn.ry}),nn=Yu({player:ot,getSelfAvatar:()=>ht.getSelfAvatar()}),ot.disable(),setTimeout(()=>{const c=document.getElementById("lu-topright");c&&(c.style.cursor="pointer",c.title="클릭하면 성능 진단 정보가 복사됩니다",c.addEventListener("click",()=>{const p=JSON.stringify({gpu:lt.name,soft:lt.soft,pixelRatio:j?j.getPixelRatio():0,aa:j?j.getContext().getContextAttributes().antialias:null,dpr:window.devicePixelRatio,screen:screen.width+"x"+screen.height,inner:window.innerWidth+"x"+window.innerHeight,cores:navigator.hardwareConcurrency||0,spec:ze(),calls:j?j.info.render.calls:0,ua:navigator.userAgent});try{navigator.clipboard.writeText(p),st("진단 정보가 복사됐어요 — 붙여넣어 보내주세요")}catch{console.info("[OpenArtShow diag]",p)}}))},0),Ar({onEnter:xi,onChatSend:yi,onAvatarChange:pi,onMakerToggle:c=>{nt&&(c?ot.disable():it.isTouring()||ot.enable())}}),Qo(!1),_r(()=>{nt&&!it.isTouring()&&ot.enable()}),Ue=si({getMp:()=>pt.getMp(),getGuestbookNotesLength:()=>Ct.length,setGuestbookStats:Gr}),pt=ei({getScene:()=>Bt,getPlayer:()=>ot,setStatus:st,getGuestbookNotes:()=>Ct,onVisitor:(c,p)=>{Ue.recordVisit(c),ci.add(p&&p.nickname,St?St.name:"")},onPhoto:c=>{an.addRemote(c),st(`${c.name||"누군가"}님이 관람 사진을 남겼어요 📸`)},onChat:(c,p)=>Yn(c,p,!1),onPlayerCount:c=>Mr(c),onRemoteGuestbook:wi,onSelfHit:c=>{st(c>=3?"아야!! 너무해요 😭":"아야! 누가 때렸어요 😣");const p=ht.getSelfAvatar();p?p.hit(c):Na(c)},onNpcHit:(c,p,w)=>{Kt&&Kt.onHit(c,p,w)},npcProvider:(c,p)=>{Kt||(Kt=new Fa(Re()));const w=Kt.update(c,p),f=Kt.takeChat();return f&&pt.getMp().sendNpcChat(f.name,f.text),w}}),Ve=Vr({getCamera:()=>dt,getRenderer:()=>j,getMp:()=>pt.getMp(),isEntered:()=>nt,isTouring:()=>it.isTouring(),viewCurrentArtwork:sn,toggleArtworkList:Wn,toggleTour:dn,toggleGuestbook:xo,flashShutter:en,capturePhoto:ln,toggleSelfView:un,tourPrev:Cn,tourNext:pn,exitTour:cn,isLightboxOpen:ie,isShareModalOpen:no,isArtworkListOpen:tn,isGuestbookOpen:Xr}),ht=ti({getScene:()=>Bt,getCamera:()=>dt,getPlayer:()=>ot,getSelfInfo:()=>se,isEntered:()=>nt,createAvatarInstance:gn,EYE_HEIGHT:vt,setStatus:st,setDockActive:qo}),Kn=Jr({getRenderer:()=>j,getScene:()=>Bt,getCamera:()=>dt,isThirdPerson:()=>ht.isThirdPerson(),getSelfAvatar:()=>ht.getSelfAvatar(),applySelfCamOffset:()=>ht.applySelfCamOffset(),restoreSelfCamOffset:()=>ht.restoreSelfCamOffset(),getGalleryInfo:()=>St,photoWall:an,getMyNickname:()=>We,getMp:()=>pt.getMp(),showShareModal:Pr,setStatus:st}),Nt=ni({camera:dt,player:ot,isEntered:()=>nt,setStatus:st}),it=Qr({getPlacedArtworks:()=>Ie,getPlayer:()=>ot,isEntered:()=>nt,getTween:()=>Nt.getTween(),clearTween:()=>Nt.clearTween(),startTween:(c,p)=>Nt.startTween(c,p),getViewingPose:xn,showTourBar:Nr,hideTourBar:Ir,setDockActive:qo,isLightboxOpen:ie,isArtworkListOpen:tn,hideArtworkList:pe}),Ee=oi({renderer:j,camera:dt,gpuInfo:lt,getMp:()=>pt.getMp(),isEntered:()=>nt,setFPS:Tr,setStatus:st}),Ee.setShadowInterval(l==="cycle"?2:0),location.search.includes("debug=perf")&&Da(()=>import("./debug-perf-BPvEucCo.js"),[]).then(c=>c.mountPerfHud(j,"index",{getSpec:ze,getLite:()=>Ee?.getLite?.()})),window.addEventListener("resize",Di),window.addEventListener("keydown",bi),li({renderer:j,scene:Bt,camera:dt,player:ot,gpuInfo:lt,flyController:nn,tourController:it,multiplayerController:pt,selfViewController:ht,viewfxController:Nt,perfGovernor:Ee,sceneTick:ku,getNearbyArtwork:mn,showArtworkInfo:Er,hideArtworkInfo:Sr,setStatus:st}).start()}function gi(){fetch("./galleries/index.json").then(t=>{if(!t.ok)throw new Error(`HTTP ${t.status}`);return t.json()}).then(t=>{if(!Array.isArray(t))return;const e=St?St.id:null;zr(t,e,n=>{window.location.href="./index.html?g="+n})}).catch(()=>{})}function sn(){if(!nt||ie())return;const t=it.isTouring()?Ie[it.getIndex()]:mn(dt.position);t&&(Vn(t),ot.disable())}function ln(){Kn.capturePhoto()}function bi(t){Ve.onKeyDown(t)}function Zn(t){if(!t||!nt)return;const e=xn(t),n=it.isTouring();n&&it.syncOnSelect(t),Nt.startTween(e,()=>{ot.setPose(e),n?it.onArrive(t):nt&&!ie()&&ot.enable()})}function cn(){it.exitTour()}function dn(){it.toggleTour()}function pn(){it.next()}function Cn(){it.prev()}function mi(){it.toggleAuto()}function xi({nickname:t,color:e,char:n}){We=t,se={nickname:t,color:e,char:n},nt=!0,kr(),ot.enable(),Tu(),Nt.startOnboarding();const o=Ue.computeRoomSuffix(St);if(!pt.connect({nickname:t,color:e,char:n,roomId:`${za}-${o}`})){st("멀티플레이어 연결에 실패했습니다. 혼자 관람 모드로 진행합니다.");return}Ue.begin(o)}function Bi(t){if(!t)return;const e=Ia(We,t);Ct=Bn(Ct,[e]),wn(je,Ct),ko(Ct);const n=pt.getMp();if(n)try{n.sendGuestbook([e])}catch(o){console.error("방명록 전송 실패:",o)}}function wi(t){Ct=Bn(Ct,t),wn(je,Ct),ko(Ct)}function yi(t){if(!t)return;Yn(We,t,!0);const e=pt.getMp();if(e)try{e.sendChat(t)}catch(n){console.error("채팅 전송 실패:",n),st("채팅 전송에 실패했습니다.")}}function Di(){Ve.onWindowResize()}window.addEventListener("beforeunload",()=>{Ve?.onBeforeUnload()});hi().catch(t=>{console.error("초기화 실패:",t);try{st("초기화 중 오류가 발생했습니다. 페이지를 새로고침해 주세요.")}catch{document.body.insertAdjacentHTML("beforeend",`<div style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);color:#fff;font-family:${ue()};font-size:16px;text-align:center;">초기화 중 오류가 발생했습니다.<br>페이지를 새로고침해 주세요.</div>`)}});const qn=0,Jn=7.5,vi=0,Se=3.3,_t=3.5,wt=.18,Me=.2,Ai=7530209,ki=3.6,Ei=1.15,Si="ontouchstart"in window||(navigator.maxTouchPoints||0)>0;function Mi(){const t=document.createElement("canvas");t.width=t.height=512;const e=t.getContext("2d");let n=20935;const o=()=>{n|=0,n=n+1831565813|0;let s=Math.imul(n^n>>>15,1|n);return s=s+Math.imul(s^s>>>7,61|s)^s,((s^s>>>14)>>>0)/4294967296},a=e.createLinearGradient(0,0,0,512);a.addColorStop(0,"#070a16"),a.addColorStop(.55,"#111a34"),a.addColorStop(1,"#1b2748"),e.fillStyle=a,e.fillRect(0,0,512,512);for(let s=0;s<140;s++){const d=o()*512,m=o()*310,x=o()<.08;e.fillStyle=`rgba(235,240,255,${(.28+o()*.6).toFixed(2)})`,e.fillRect(d,m,x?2:1,x?2:1)}const u=e.createRadialGradient(398,88,0,398,88,36);u.addColorStop(0,"rgba(236,239,232,0.9)"),u.addColorStop(.5,"rgba(226,232,224,0.42)"),u.addColorStop(1,"rgba(226,232,224,0)"),e.fillStyle=u,e.beginPath(),e.arc(398,88,36,0,7),e.fill(),e.fillStyle="rgba(240,243,236,0.95)",e.beginPath(),e.arc(398,88,15,0,7),e.fill();let r=0;for(;r<512;){const s=26+o()*48,d=130+o()*250,m=512-d;e.fillStyle=`rgb(${10+(o()*8|0)},${16+(o()*10|0)},${34+(o()*14|0)})`,e.fillRect(r,m,s,d);for(let x=m+12;x<506;x+=15)for(let g=r+6;g<r+s-6;g+=12)o()<.52||(e.fillStyle=o()<.72?"rgba(120,220,225,0.85)":"rgba(255,207,138,0.85)",e.fillRect(g,x,4,6));r+=s+2+o()*8}const l=new le(t);return l.colorSpace=Lt,l}function Ti(){const t=document.createElement("canvas");t.width=512,t.height=160;const e=t.getContext("2d");e.clearRect(0,0,512,160),e.font='700 92px "Apple SD Gothic Neo","Malgun Gothic",system-ui,sans-serif',e.textAlign="center",e.textBaseline="middle",e.shadowColor="rgba(114,230,225,0.95)",e.shadowBlur=30,e.fillStyle="rgba(175,244,240,0.96)",e.fillText("오픈월드",256,86),e.shadowBlur=0,e.fillStyle="rgba(224,252,250,0.92)",e.fillText("오픈월드",256,86);const n=new le(t);return n.colorSpace=Lt,n}function Li(){const t=new $t,e=[new V(Se,wt,Me).translate(0,wt/2,0),new V(Se,wt,Me).translate(0,_t-wt/2,0),new V(wt,_t,Me).translate(-3.1199999999999997/2,_t/2,0),new V(wt,_t,Me).translate((Se-wt)/2,_t/2,0)],n=Fe(e);e.forEach(r=>r.dispose());const o=new ut({color:736570,emissive:Ai,emissiveIntensity:1.5,roughness:.4,metalness:.1});t.add(new G(n,o));const a=new G(new q(Se-2*wt,_t-2*wt),new Gt({map:Mi(),toneMapped:!1}));a.position.set(0,_t/2,.11),a.rotation.y=Math.PI,t.add(a);const u=new G(new q(2.4,.75),new Gt({map:Ti(),transparent:!0,toneMapped:!1,depthWrite:!1,side:de}));return u.rotation.x=Math.PI/2,u.scale.x=-1,u.position.set(0,.02,-1),t.add(u),t.position.set(qn,vi,Jn),t.userData={frameMat:o,label:u},t}let It=null,Te=null,xt=null,ae=!1,Bo=!1,Qn=0,ta=0;function zi(){xt||(xt=document.createElement("div"),xt.id="portal-hint",xt.textContent=Si?"탭하여 오픈월드로 이동 →":"클릭하거나 다가가면 오픈월드로 이동 →",xt.style.cssText='position:fixed;left:50%;bottom:96px;transform:translateX(-50%);z-index:40;padding:9px 16px;border-radius:999px;background:rgba(11,30,29,0.82);color:#c9fbf8;font:600 13px/1 "Apple SD Gothic Neo","Malgun Gothic",system-ui,sans-serif;letter-spacing:-.01em;border:1px solid rgba(114,230,225,0.5);box-shadow:0 6px 20px -6px rgba(0,0,0,0.6);-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);pointer-events:none;opacity:0;transition:opacity .25s;white-space:nowrap',document.body.appendChild(xt))}function ea(){Bo||(Bo=!0,xt&&(xt.style.opacity="0"),location.href="world.html")}function oa(){if(requestAnimationFrame(oa),!It){if(It=window.__museum||null,!It)return;Te=Li(),It.scene.add(Te),zi()}const t=performance.now()/1e3,e=1.3+Math.sin(t*2.2)*.35;Te.userData.frameMat.emissiveIntensity=e,Te.userData.label.material.opacity=.78+Math.sin(t*2.2)*.2;const n=It.camera,o=Math.hypot(n.position.x-qn,n.position.z-Jn),a=ae;ae=o<ki,ae!==a&&xt&&(xt.style.opacity=ae?"1":"0"),o<Ei&&ea()}requestAnimationFrame(oa);addEventListener("pointerdown",t=>{Qn=t.clientX,ta=t.clientY},!0);addEventListener("pointerup",t=>{!ae||Bo||!It||t.target===It.renderer.domElement&&(Math.hypot(t.clientX-Qn,t.clientY-ta)>8||ea())},!0);
