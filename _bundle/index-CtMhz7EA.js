/* empty css              */import{e as Ht,M as H,d as q,i as W,k as rt,G as $t,T as la,l as ao,m as Jt,n as hn,h as At,o as ca,p as gn,q as ue,r as da,s as ge,F as Ve,t as be,L as ua,u as Pe,B as _o,v as pa,O as fa,H as bn,D as Zt,w as ha,S as Nt,x as ce,f as mn,y as xn,E as wn,z as bt,W as yn,I as ga,N as vn,a as kn,b as Sn,J as ba,V as No,Q as ma,C as xa,R as wa,P as ya,A as va}from"./vendor-three-enYtijzV.js";import{B as O,b as ro,a as Cn,E as Ct,R as me,c as En,A as io,g as Oe,d as re,M as ka,e as Sa,f as Ca,h as Ea,l as Ma,i as Mn,P as Ta,j as La,N as za,p as _a,k as Tn,m as Na,n as Ln,s as zn}from"./multiplayer-B2R9PNWM.js";import{g as Aa,c as _n,a as Ia,b as so,m as _e,d as Ao,e as Ra,f as Pa,T as Rt,h as Be,i as Oa,j as Ba,r as Da,k as Nn,l as An,C as Ga}from"./scene-textures-DhUb9KjO.js";import{P as Ha,V as Fa}from"./feed-Cm56rHm1.js";import{n as Ke,D as Ne,C as Xa,a as Ya,S as Io,c as Ro,e as lo,d as Ua,f as ja,g as $a,h as Wa,i as Va,j as Ka,E as Za,k as qa,H as Po,l as Ja,m as Qa,o as tr,p as Ze,q as er,r as or}from"./chibi-builder-0e8j20Jr.js";import{g as zt,o as In,P as xe,l as nr,M as ar,a as rr}from"./auth-aZ7HCW1S.js";function Oo(t,e){let n=[t];for(const o of e){const a=[];for(const r of n){if(o.x1<=r.x0||o.x0>=r.x1||o.z1<=r.z0||o.z0>=r.z1){a.push(r);continue}const i=Math.max(r.x0,o.x0),c=Math.min(r.x1,o.x1),l=Math.max(r.z0,o.z0),u=Math.min(r.z1,o.z1);r.z0<l&&a.push({x0:r.x0,x1:r.x1,z0:r.z0,z1:l}),u<r.z1&&a.push({x0:r.x0,x1:r.x1,z0:u,z1:r.z1}),r.x0<i&&a.push({x0:r.x0,x1:i,z0:l,z1:u}),c<r.x1&&a.push({x0:c,x1:r.x1,z0:l,z1:u})}n=a}return n.filter(o=>o.x1-o.x0>.01&&o.z1-o.z0>.01)}function ht(t){return O.floors.find(e=>e.id===t)}function ir(t,e){const n=_n(),o=16/50,a=t.x1-t.x0,r=t.z1-t.z0,i=n.map.clone(),c=n.normalMap.clone();for(const l of[i,c])l.needsUpdate=!0,l.repeat.set(o*a,o*r),l.offset.set((t.x0-O.minX)*o%1,(t.z0-O.minZ)*o%1);return new rt({map:i,normalMap:c,normalScale:new At(.7,.7),color:e,roughness:.4,metalness:0})}function Mt(t,e,n){const o=Ia(),a=o.map.clone(),r=o.normalMap.clone();for(const i of[a,r])i.needsUpdate=!0,i.repeat.set(t,e);return new rt({map:a,normalMap:r,normalScale:new At(.55,.55),color:n||16777215,roughness:.9,metalness:0})}function Rn(){return new rt({map:so().map,normalMap:so().normalMap,normalScale:new At(.35,.35),color:16777215,roughness:.92,metalness:0})}const de=()=>new rt({color:2499615,roughness:.4,metalness:.75});function xt(t,e,n,o,a,r){const i=de(),c=new gn({color:14214376,transparent:!0,opacity:.22,roughness:.08,side:ue,depthWrite:!1}),l=Math.hypot(o-e,a-n),u=Math.atan2(o-e,a-n),m=(e+o)/2,w=(n+a)/2,b=new $t,g=new H(new Jt(.03,.03,l,10),i);g.rotation.x=Math.PI/2,g.position.y=1.05,b.add(g);const d=Math.max(2,Math.round(l/1.2)+1);for(let v=0;v<d;v++){const h=d===1?.5:v/(d-1),f=new H(new W(.045,1.05,.045),i);f.position.set(0,.525,-l/2+h*l),b.add(f)}const p=new H(new q(l,.85),c);p.rotation.y=Math.PI/2,p.position.y=.55,b.add(p),b.rotation.y=u,b.position.set(m,r,w),b.traverse(v=>{v.isMesh&&(v.castShadow=!0)}),t.add(b)}function sr(t,e){const n=Mt(1.2,2.4),o=e.yTo-e.yFrom,a=e.z1-e.z0,r=24,i=o/r,c=a/r,l=e.x1-e.x0,u=(e.x0+e.x1)/2;for(let g=0;g<r;g++){const d=e.yFrom+(g+1)*i,p=d-e.yFrom+.25,v=new H(new W(l,p,c),n);v.position.set(u,d-p/2,e.z0+(g+.5)*c),v.castShadow=!0,v.receiveShadow=!0,t.add(v)}const m=de(),w=Math.hypot(a,o),b=Math.atan2(o,a);for(const g of[e.x0+.06,e.x1-.06]){const d=new H(new Jt(.03,.03,w,10),m);d.rotation.x=Math.PI/2-b,d.position.set(g,(e.yFrom+e.yTo)/2+.95,(e.z0+e.z1)/2),d.castShadow=!0,t.add(d);for(const p of[.08,.5,.92]){const v=e.yFrom+o*p,h=new H(new W(.045,.95,.045),m);h.position.set(g,v+.475,e.z0+a*p),h.castShadow=!0,t.add(h)}}}function lr(t,e,n,o,a,r,i){const c=e+O.clearH,l=.32,u=.14,m=1.1,w=Mt(2,.4,13617599),b=new rt({color:3486253,normalMap:so().normalMap,normalScale:new At(.25,.25),roughness:.95}),g=new rt({color:1710102,roughness:.5,metalness:.6}),d=new rt({color:16774880,emissive:a.downlight.emissive,emissiveIntensity:2.5*(a.downlight.intensity/22),roughness:1}),p=[],v=[],h=[];for(const f of n){const N=f.x1-f.x0,M=f.z1-f.z0,_=new H(new q(N,M),b);_.rotation.x=Math.PI/2,_.position.set((f.x0+f.x1)/2,c+l,(f.z0+f.z1)/2),t.add(_);const T=Math.ceil((f.z0-O.minZ)/m);for(let x=T;;x++){const y=O.minZ+x*m;if(y>f.z1-.05)break;if(y<f.z0+.05)continue;const E=new W(N,l,u);E.translate((f.x0+f.x1)/2,c+l/2,y),p.push(E)}const C=Math.ceil((f.x0-O.minX)/m);for(let x=C;;x++){const y=O.minX+x*m;if(y>f.x1-.05)break;if(y<f.x0+.05)continue;const E=new W(u,l,M);E.translate(y,c+l/2,(f.z0+f.z1)/2),p.push(E)}for(let x=C;;x++){const y=O.minX+x*m+m/2;if(y>f.x1-.2)break;if(!(y<f.x0+.2))for(let E=T;;E++){const R=O.minZ+E*m+m/2;if(R>f.z1-.2)break;if(R<f.z0+.2||(x*7+E*5)%3!==0)continue;const z=new Jt(.07,.08,.1,12);z.translate(y,c+l-.06,R),v.push(z);const B=new Jt(.055,.055,.02,12);B.translate(y,c+l-.12,R),h.push(B)}}}if(p.length){const f=new H(_e(p),w);f.castShadow=!0,t.add(f)}if(v.length&&t.add(new H(_e(v),g)),h.length&&t.add(new H(_e(h),d)),i)for(const[f,N]of r){const M=new ca(a.downlight.color,a.downlight.intensity*.7,9,2);M.position.set(f,c-.15,N),t.add(M),o.push(M)}return d}function cr(t){const e=new gn({color:14478578,transparent:!0,opacity:.1,roughness:.05,side:ue,depthWrite:!1}),n=de(),o=O.maxZ,a=O.maxX-O.minX,r=ht("f1"),i=ht("f2"),c=O.clearH;for(const[p,v]of[[O.minX,-1.5],[1.5,O.maxX]]){const h=v-p,f=new H(new q(h,c),e);f.position.set((p+v)/2,r.y+c/2,o),f.rotation.y=Math.PI,t.add(f)}for(let p=O.minX;p<=O.maxX+.01;p+=2.2){if(p>-1.5&&p<1.5)continue;const v=new H(new W(.12,c,.12),n);v.position.set(p,r.y+c/2,o),v.castShadow=!0,t.add(v)}for(const p of[-1.5,1.5]){const v=new H(new W(.18,c,.18),n);v.position.set(p,r.y+c/2,o),v.castShadow=!0,t.add(v)}const l=new H(new W(a,.14,.16),n);l.position.set(0,r.y+c-.07,o),t.add(l);const u=Rn(),m=new H(new W(a,1.2,O.wallT),u);m.position.set(0,i.y+.6,o),m.castShadow=!0,m.receiveShadow=!0,t.add(m);const w=new H(new W(a,O.clearH-2.6+.6,O.wallT),u);w.position.set(0,i.y+2.6+(O.clearH-2.6+.6)/2,o),w.castShadow=!0,w.receiveShadow=!0,t.add(w);const b=new H(new q(a,1.4),e);b.position.set(0,i.y+1.9,o),b.rotation.y=Math.PI,t.add(b);for(let p=O.minX;p<=O.maxX+.01;p+=2.2){const v=new H(new W(.08,1.4,.08),n);v.position.set(p,i.y+1.9,o),t.add(v)}const g=ht("b1"),d=new H(new W(a+.6,O.storyH,O.wallT),Mt(4,1));d.position.set(0,g.y+O.storyH/2,o),t.add(d)}function dr(t,e,n){const o=O,a=o.maxX-o.minX,r=o.maxZ-o.minZ,i={x0:o.minX,x1:o.maxX,z0:o.minZ,z1:o.maxZ},c=[];let l=null;const u=["b1","f1","f2"];for(const S of o.floors){const I=o.slabHoles[S.id]||[],X=Oo(i,I);for(const Y of X){const K=Y.x1-Y.x0,j=Y.z1-Y.z0,V=new H(new W(K,o.slabT,j),Mt(K/6,j/6));V.position.set((Y.x0+Y.x1)/2,S.y-o.slabT/2,(Y.z0+Y.z1)/2),V.castShadow=!0,V.receiveShadow=!0,t.add(V);const Z=new H(new q(K,j),ir(Y,S.id==="b1"?10127472:S.id==="roof"?13482132:16777215));Z.rotation.x=-Math.PI/2,Z.position.set((Y.x0+Y.x1)/2,S.y+.002,(Y.z0+Y.z1)/2),Z.receiveShadow=!0,t.add(Z)}}const m={b1:[[-6,-3],[0,-3],[6,-3],[0,3]],f1:[[-7,-4],[0,-4],[7,-4],[-7,4],[0,4],[7,4]],f2:[[-7,-4.5],[0,-4.5],[7,-4.5],[-7,5],[7,5]]},w={b1:"f1",f1:"f2",f2:"roof"};for(const S of u){const I=ht(S),X=o.slabHoles[w[S]]||[],Y=Oo(i,X),K=lr(t,I.y,Y,c,e,m[S],n);l||(l=K)}const b=Mt(3,2),g=ht("roof").y-ht("b1").y,d=ht("b1").y+g/2,p=new H(new W(a+o.wallT*2,g,o.wallT),b);p.position.set(0,d,o.minZ-o.wallT/2),p.castShadow=!0,p.receiveShadow=!0,t.add(p);for(const[S,I]of[[o.minX-o.wallT/2,1],[o.maxX+o.wallT/2,1]]){const X=new H(new W(o.wallT,g,r),b);X.position.set(S,d,0),X.castShadow=!0,X.receiveShadow=!0,t.add(X)}for(const S of u){const I=ht(S),X=Rn(),Y=[{w:a,h:O.clearH,x:0,z:o.minZ+.02,ry:0},{w:r,h:O.clearH,x:o.maxX-.02,z:0,ry:-Math.PI/2},{w:r,h:O.clearH,x:o.minX+.02,z:0,ry:Math.PI/2}];for(const K of Y){const j=new H(new q(K.w,K.h),X);j.position.set(K.x,I.y+O.clearH/2,K.z),j.rotation.y=K.ry,j.receiveShadow=!0,t.add(j)}}cr(t);for(const S of o.stairs)sr(t,S);const v=ht("f1").y,h=ht("f2").y,f=ht("roof").y;xt(t,-8.7,-7,-8.7,-1,v),xt(t,-10.7,-7,-8.7,-7,v),xt(t,-8.7,1,-8.7,7,h),xt(t,-10.7,1,-8.7,1,h),xt(t,-4,-3,5,-3,h),xt(t,-4,3,5,3,h),xt(t,-4,-3,-4,3,h),xt(t,5,-3,5,3,h),xt(t,8.7,1,8.7,7,f),xt(t,8.7,1,10.7,1,f);const N=Mt(4,.5),M=1.1,_=.25,T=[{w:a+.6,d:_,x:0,z:o.minZ-_/2},{w:a+.6,d:_,x:0,z:o.maxZ+_/2},{w:_,d:r,x:o.minX-_/2,z:0},{w:_,d:r,x:o.maxX+_/2,z:0}];for(const S of T){const I=new H(new W(S.w,M,S.d),N);I.position.set(S.x,f+M/2,S.z),I.castShadow=!0,I.receiveShadow=!0,t.add(I)}const C=new rt({map:_n().map,color:12163695,roughness:.6});for(const[S,I]of[[-4,4],[2,-4]]){const X=new H(new W(2.2,.09,.55),C);X.position.set(S,f+.45,I),X.castShadow=!0,t.add(X);for(const Y of[-.9,.9]){const K=new H(new W(.08,.42,.5),de());K.position.set(S+Y,f+.21,I),t.add(K)}}const x=new rt({color:5194806,roughness:.45,metalness:.65}),y=new $t,E=new H(new la(1.3,.42,14,28,Math.PI),x);E.castShadow=!0,y.add(E);const R=new H(new ao(.55,18,14),x);R.scale.set(1.5,.75,1),R.position.set(1.1,-.95,.2),R.castShadow=!0,y.add(R),y.position.set(-2,f+1.35,.5),y.rotation.y=-.6,t.add(y);const z=new H(new Jt(1.9,1.9,.12,24),Mt(1,1,14209994));z.position.set(-2,f+.06,.5),z.receiveShadow=!0,t.add(z);const B=new H(new W(2.8,.18,7.2),Mt(1,2));B.position.set(9.7,f+2.6,4),B.castShadow=!0,t.add(B);for(const[S,I]of[[8.85,.8],[10.55,.8],[8.85,7.2],[10.55,7.2]]){const X=new H(new W(.12,2.6,.12),de());X.position.set(S,f+1.3,I),t.add(X)}let L=null;return n||(L=new hn(e.downlight.color,e.downlight.intensity*.022),t.add(L)),{downlights:{lights:c,warm:L,bulbMat:l}}}function ur(t){const{minX:e,maxX:n,minZ:o,maxZ:a,wallT:r}=O,i=.55,c=e+r/2,l=n-r/2,u=o+r/2,m=a-r/2,w=new Ht({map:Aa(),transparent:!0,depthWrite:!1});for(const b of O.floors){if(b.id==="roof")continue;const g=b.y+.018,d=[[l-c,(c+l)/2,u+i/2,Math.PI],[l-c,(c+l)/2,m-i/2,0],[m-u,c+i/2,(u+m)/2,-Math.PI/2],[m-u,l-i/2,(u+m)/2,Math.PI/2]];for(const[p,v,h,f]of d){const N=new H(new q(p,i),w);N.rotation.x=-Math.PI/2,N.rotation.z=f,N.position.set(v,g,h),N.renderOrder=1,t.add(N)}}}class pr extends da{constructor(e){super(e),this.type=ge}parse(e){const i=function(x,y){switch(x){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(y||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(y||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(y||""));default:case 4:throw new Error("THREE.RGBELoader: Memory Error: "+(y||""))}},m=`
...
`;continue}if((I=S.match(E))&&(L.gamma=parseFloat(I[1])),(I=S.match(R))&&(L.exposure=parseFloat(I[1])),(I=S.match(z))&&(L.valid|=2,L.format=I[1]),(I=S.match(B))&&(L.valid|=4,L.height=parseInt(I[1],10),L.width=parseInt(I[2],10)),L.valid&2&&L.valid&4)break}return L.valid&2||i(3,"missing format specifier"),L.valid&4||i(3,"missing image size specifier"),L},g=function(x,y,E){const R=y;if(R<8||R>32767||x[0]!==2||x[1]!==2||x[2]&128)return new Uint8Array(x);R!==(x[2]<<8|x[3])&&i(3,"wrong scanline width");const z=new Uint8Array(4*y*E);z.length||i(4,"unable to allocate buffer space");let B=0,L=0;const S=4*R,I=new Uint8Array(4),X=new Uint8Array(S);let Y=E;for(;Y>0&&L<x.byteLength;){L+4>x.byteLength&&i(1),I[0]=x[L++],I[1]=x[L++],I[2]=x[L++],I[3]=x[L++],(I[0]!=2||I[1]!=2||(I[2]<<8|I[3])!=R)&&i(3,"bad rgbe scanline format");let K=0,j;for(;K<S&&L<x.byteLength;){j=x[L++];const Z=j>128;if(Z&&(j-=128),(j===0||K+j>S)&&i(3,"bad scanline data"),Z){const Q=x[L++];for(let fe=0;fe<j;fe++)X[K++]=Q}else X.set(x.subarray(L,L+j),K),K+=j,L+=j}const V=R;for(let Z=0;Z<V;Z++){let Q=0;z[B]=X[Z+Q],Q+=R,z[B+1]=X[Z+Q],Q+=R,z[B+2]=X[Z+Q],Q+=R,z[B+3]=X[Z+Q],B+=4}Y--}return z},d=function(x,y,E,R){const z=x[y+3],B=Math.pow(2,z-128)/255;E[R+0]=x[y+0]*B,E[R+1]=x[y+1]*B,E[R+2]=x[y+2]*B,E[R+3]=1},p=function(x,y,E,R){const z=x[y+3],B=Math.pow(2,z-128)/255;E[R+0]=be.toHalfFloat(Math.min(x[y+0]*B,65504)),E[R+1]=be.toHalfFloat(Math.min(x[y+1]*B,65504)),E[R+2]=be.toHalfFloat(Math.min(x[y+2]*B,65504)),E[R+3]=be.toHalfFloat(1)},v=new Uint8Array(e);v.pos=0;const h=b(v),f=h.width,N=h.height,M=g(v.subarray(v.pos),f,N);let _,T,C;switch(this.type){case Ve:C=M.length/4;const x=new Float32Array(C*4);for(let E=0;E<C;E++)d(M,E*4,x,E*4);_=x,T=Ve;break;case ge:C=M.length/4;const y=new Uint16Array(C*4);for(let E=0;E<C;E++)p(M,E*4,y,E*4);_=y,T=ge;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:f,height:N,data:_,header:h.string,gamma:h.gamma,exposure:h.exposure,type:T}}setDataType(e){return this.type=e,this}load(e,n,o,a){function r(i,c){switch(i.type){case Ve:case ge:i.colorSpace=ua,i.minFilter=Pe,i.magFilter=Pe,i.generateMipmaps=!1,i.flipY=!0;break}n&&n(i,c)}return super.load(e,r,o,a)}}const vo=[];function Bo(t){const n=document.createElement("canvas");n.width=1024,n.height=1024;const o=n.getContext("2d"),a=o.createLinearGradient(0,0,0,1024);for(const[u,m]of t.stops)a.addColorStop(u,m);if(o.fillStyle=a,o.fillRect(0,0,1024,1024),t.stars>0){const u=Be(90210);for(let m=0;m<t.stars;m++){const w=u()*1024,b=u()*1024*.82,g=.4+u()*1.6,d=.35+u()*.65;if(u()>.965){const p=o.createRadialGradient(w,b,0,w,b,g*5);p.addColorStop(0,`rgba(255, 255, 255, ${d*.5})`),p.addColorStop(1,"rgba(255,255,255,0)"),o.fillStyle=p,o.beginPath(),o.arc(w,b,g*5,0,Math.PI*2),o.fill()}o.fillStyle=`rgba(255, 255, 255, ${d})`,o.beginPath(),o.arc(w,b,g,0,Math.PI*2),o.fill()}}const r=Be(13579),[i,c]=t.cloudAlpha;for(let u=0;u<t.cloudCount;u++){const m=r()*1024,w=1024*(.3+r()*.45),b=30+r()*90;for(let g=0;g<7;g++){const d=m+(r()-.5)*b*2.4,p=w+(r()-.5)*b*.7,v=b*(.35+r()*.5),h=o.createRadialGradient(d,p,0,d,p,v);h.addColorStop(0,`rgba(${t.cloudColor}, ${i+r()*(c-i)})`),h.addColorStop(1,`rgba(${t.cloudColor}, 0)`),o.fillStyle=h,o.beginPath(),o.arc(d,p,v,0,Math.PI*2),o.fill()}}const l=new ce(n);return l.colorSpace=Nt,l}const fr={daylight:"./assets/sky/day.hdr",sunset:"./assets/sky/sunset.hdr",night:"./assets/sky/night.jpg"};function we(t,e){const n=fr[e],o=r=>{r.minFilter=Pe,r.magFilter=Pe,t.map=r,t.needsUpdate=!0},a=()=>{};n.endsWith(".hdr")?new pr().load(n,o,void 0,a):new ha().load(n,r=>{r.colorSpace=Nt,o(r)},void 0,a)}function hr(t,e,n){if(n){const r=(u,m)=>new H(new ao(m,32,16),new Ht({map:Bo(u),side:_o,fog:!1,transparent:!0,depthWrite:!1,opacity:0})),i=r(Rt.night.sky,450),c=r(Rt.sunset.sky,448),l=r(Rt.daylight.sky,446);for(const u of[i,c,l])u.position.y=-70;return i.renderOrder=-3,c.renderOrder=-2,l.renderOrder=-1,t.add(i,c,l),we(l.material,"daylight"),we(c.material,"sunset"),we(i.material,"night"),{daylight:l,sunset:c,night:i}}const o=e===Rt.sunset?"sunset":e===Rt.night?"night":"daylight",a=new H(new ao(450,32,16),new Ht({map:Bo(e.sky),side:_o,fog:!1}));return a.position.y=-70,t.add(a),we(a.material,o),null}function gr(t,e){const n=new H(new q(800,800),new rt({map:Ao().map,normalMap:Ao().normalMap,normalScale:new At(.6,.6),color:e.grassTint,roughness:.95,metalness:0}));n.rotation.x=-Math.PI/2,n.position.y=-.03,n.receiveShadow=!0,t.add(n);const o=new H(new q(400,900),new rt({color:e.sea.color,roughness:e.sea.roughness,metalness:e.sea.metalness}));o.rotation.x=-Math.PI/2,o.position.set(290,-.02,0),t.add(o);const a=new H(new q(8,900),new rt({color:13220758,roughness:.9}));a.rotation.x=-Math.PI/2,a.position.set(88,-.025,0),t.add(a);const r=Be(97531),i=new $t;let c=4e4;function l(g,d,p){c+=733;const v=ro(c,{trunkLen:2.6*p,trunkRad:.24*p,maxLevel:2,leafScale:.95*p});v.position.set(g,0,d),v.rotation.y=r()*Math.PI*2,i.add(v)}[[-12,30,1],[4,31,1.15],[12,34,.9],[34,-18,1.1],[36,14,.95]].forEach(([g,d,p],v)=>{const h=ro(6e4+v*137,{trunkLen:3.2*p,trunkRad:.32*p,maxLevel:2,leafScale:1.1*p});h.position.set(g+(r()-.5)*2,0,d+(r()-.5)*2),h.rotation.y=r()*Math.PI*2,i.add(h)});const m=[[-20,33],[-4,35],[20,30],[-16,42],[-6,45],[6,43],[16,46],[0,52],[-24,50],[24,48]];for(const[g,d]of m)l(g+(r()-.5)*3,d+(r()-.5)*3,1+r()*.9);const w=[[40,-10],[44,22],[52,-18],[60,8],[48,-2]];for(const[g,d]of w)l(g+(r()-.5)*3,d+(r()-.5)*3,.9+r()*.8);const b=[[-35,-30],[-45,0],[-38,20],[-30,40],[20,-40],[-10,-38]];for(const[g,d]of b)l(g+(r()-.5)*4,d+(r()-.5)*4,1.1+r()*1);for(const g of Cn(i))t.add(g);return{seaMat:o.material}}function br(t,e){const n=ro(31415,{trunkLen:4.6,trunkRad:.42,maxLevel:3,leafScale:1.4});n.position.set(7,0,14);for(const r of Cn(n))t.add(r);const o=new H(new Jt(.42,.72,.45,9),new rt({map:Pa(),normalMap:Ra(),normalScale:new At(.9,.9),roughness:.95}));o.position.set(7,.22,14),o.castShadow=!0,t.add(o);const a=[];if(e.treeUplights)for(const[r,i]of[[5.6,13],[8.4,15]]){const c=new pa(16756838,150,15,Math.PI/5,.9,1.8);c.position.set(r,.35,i);const l=new fa;l.position.set(7,7,14),t.add(l),c.target=l,c.castShadow=!1,t.add(c),a.push(c)}return{treeUplights:a}}function Do(t,e){const n=new $t,o=new q(.16,.12);o.translate(-.09,0,0);const a=new q(.16,.12);a.translate(.09,0,0);const r=new Ht({color:e.color,side:ue}),i=new H(o,r),c=new H(a,r);i.rotation.x=-Math.PI/2,c.rotation.x=-Math.PI/2,n.add(i),n.add(c),t.add(n),vo.push({update(l){const u=l*e.speed+e.phase,m=e.cx+Math.cos(u)*e.rx,w=e.cz+Math.sin(u*e.zRatio)*e.rz,b=e.cy+Math.sin(l*e.bobSpeed+e.phase)*e.bobAmp,g=-Math.sin(u)*e.rx*e.speed,d=Math.cos(u*e.zRatio)*e.rz*e.zRatio*e.speed;n.rotation.y=Math.atan2(g,d),n.position.set(m,b,w);const p=Math.sin(l*e.flapSpeed)*1.1;i.rotation.y=p,c.rotation.y=-p}})}function mr(t,e){const n=new $t,o=new Ht({color:2763310,side:ue}),a=new q(1.6,.35);a.translate(-.8,0,0);const r=new q(1.6,.35);r.translate(.8,0,0);const i=new H(a,o),c=new H(r,o);i.rotation.x=-Math.PI/2,c.rotation.x=-Math.PI/2,n.add(i),n.add(c),t.add(n),vo.push({update(l){const u=l*e.speed+e.phase,m=e.cx+Math.cos(u)*e.radius,w=e.cz+Math.sin(u)*e.radius,b=e.cy+Math.sin(l*.3+e.phase)*2;n.rotation.y=-u-Math.PI/2,n.position.set(m,b,w);const g=Math.sin(l*e.flapSpeed+e.phase)*.55;i.rotation.y=g,c.rotation.y=-g}})}function xr(t){const e=Be(86420),n=[15241786,15979338,15262938,13070264,8368864];for(let o=0;o<5;o++)Do(t,{cx:7,cz:14,cy:1.4+e()*3,rx:1+e()*2.2,rz:1+e()*2.2,zRatio:.7+e()*.6,speed:.35+e()*.4,phase:e()*Math.PI*2,bobSpeed:1.5+e()*1.5,bobAmp:.3+e()*.3,flapSpeed:9+e()*5,color:n[o%n.length]});for(let o=0;o<4;o++)Do(t,{cx:-14+o*10+e()*4,cz:30+e()*8,cy:1.2+e()*2,rx:1.5+e()*3,rz:1.5+e()*3,zRatio:.6+e()*.8,speed:.3+e()*.35,phase:e()*Math.PI*2,bobSpeed:1.2+e()*1.6,bobAmp:.35+e()*.4,flapSpeed:8+e()*5,color:n[(o+2)%n.length]});for(let o=0;o<3;o++)mr(t,{cx:20+e()*30,cz:-10+e()*40,cy:26+e()*12,radius:55+e()*45,speed:.04+e()*.03,phase:e()*Math.PI*2,flapSpeed:2.2+e()*1.2})}function wr(t,e){const n=new bn(e.hemi.sky,e.hemi.ground,e.hemi.intensity);n.position.set(0,40,0),t.add(n);const o=new hn(e.ambient.color,e.ambient.intensity);t.add(o);const a=new Zt(e.sun.color,e.sun.intensity);a.position.set(...e.sun.pos),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.bias=-5e-4,a.shadow.normalBias=.02;const r=e.shadowCamera;a.shadow.camera.left=r.left,a.shadow.camera.right=r.right,a.shadow.camera.top=r.top,a.shadow.camera.bottom=r.bottom,a.shadow.camera.near=r.near,a.shadow.camera.far=r.far,t.add(a),t.add(a.target);const i=new Zt(e.fill.color,e.fill.intensity);return i.position.set(...e.fill.pos),t.add(i),{hemi:n,ambient:o,sun:a,fill:i}}function yr(t){for(const e of vo)e.update(t)}let Tt=null,Go=0;function vr(t){Go+=t,yr(Go),Tt&&(Tt.phase=(Tt.phase+t/Ga)%1,Nn(Tt,An(Tt.phase)))}function kr(t,e="daylight",n={}){const o=n.fullLights!==!1,a=e==="cycle",r=a?Oa():0,i=a?Ba(r):Da(e);t.background=new mn(i.background),t.fog=new xn(i.fog.color,i.fog.near,i.fog.far);const c=hr(t,i,a),l=gr(t,i);ur(t);const u=dr(t,i,o),m=br(t,i),w=u.downlights,b=wr(t,i);if(xr(t),a){const g=new Zt(Rt.night.sun.color,0);g.position.set(...Rt.night.sun.pos),t.add(g),t.add(g.target),Tt={scene:t,phase:r,sunLight:b.sun,hemiLight:b.hemi,ambientLight:b.ambient,moonLight:g,seaMat:l.seaMat,downlights:w,treeUplights:m.treeUplights,skyDomes:c},b.sun.shadow.camera.updateProjectionMatrix(),Nn(Tt,An(r))}else Tt=null;return{bounds:{minX:O.minX+.6,maxX:O.maxX-.6,minZ:O.minZ+.6,maxZ:O.maxZ-.6}}}let at=null,ie=null,ne=!1;function Sr(t,e){if(!at)return;const n=new StereoPannerNode(at,{pan:e});n.connect(ie);const o=2+Math.floor(Math.random()*4);let a=at.currentTime+.02;for(let r=0;r<o;r++){const i=at.createOscillator(),c=at.createGain();i.connect(c),c.connect(n);const l=t*(.85+Math.random()*.4),u=l*(Math.random()>.5?1.25:.78),m=.05+Math.random()*.1;i.type="sine",i.frequency.setValueAtTime(l,a),i.frequency.exponentialRampToValueAtTime(u,a+m),c.gain.setValueAtTime(1e-4,a),c.gain.exponentialRampToValueAtTime(.55,a+.012),c.gain.exponentialRampToValueAtTime(1e-4,a+m),i.start(a),i.stop(a+m+.02),a+=m+.04+Math.random()*.09}}function Cr(){const t=at.sampleRate*4,e=at.createBuffer(1,t,at.sampleRate),n=e.getChannelData(0);let o=0;for(let c=0;c<t;c++){const l=Math.random()*2-1;o=(o+.02*l)/1.02,n[c]=o*3.5}const a=at.createBufferSource();a.buffer=e,a.loop=!0;const r=at.createBiquadFilter();r.type="lowpass",r.frequency.value=400;const i=at.createGain();i.gain.value=.012,a.connect(r),r.connect(i),i.connect(ie),a.start()}function co(){if(!ne)return;const t=[{base:2600,pan:-.7},{base:3400,pan:.6},{base:4200,pan:.15}],e=t[Math.floor(Math.random()*t.length)];Sr(e.base,e.pan+(Math.random()-.5)*.3);const n=900+Math.random()*4200;setTimeout(co,n)}function Er(){if(!ne)try{at=new(window.AudioContext||window.webkitAudioContext),ie=at.createGain(),ie.gain.value=.05,ie.connect(at.destination),at.state==="suspended"&&at.resume(),ne=!0,Cr(),co(),setTimeout(()=>{ne&&co()},2500)}catch{ne=!1}}const ee=2.5,Ho=4.5,Fo=.0022,Xo=.0058,ye=bt.degToRad(89),Mr=.03,Tr=7.5,ve=60,St=.45,Yo=.65,Lr=12;function zr(t,e){for(const n of O.stairs){const o=Math.min(n.x0,n.x1),a=Math.max(n.x0,n.x1);if(t<o||t>a)continue;const r=Math.min(n.z0,n.z1),i=Math.max(n.z0,n.z1);if(e<r||e>i)continue;const c=bt.clamp((e-n.z0)/(n.z1-n.z0),0,1);return n.yFrom+c*(n.yTo-n.yFrom)}return null}function _r(t,e,n){return e>=t.x0&&e<=t.x1&&n>=t.z0&&n<=t.z1}function Nr(t,e){return t>=O.minX&&t<=O.maxX&&e>=O.minZ&&e<=O.maxZ}function Pn(t,e){const n=[],o=zr(t,e);if(o!==null&&n.push(o),Nr(t,e))for(const a of O.floors){const r=O.slabHoles[a.id]||[];let i=!1;for(const c of r)if(_r(c,t,e)){i=!0;break}i||n.push(a.y)}else n.push(0);return n}function Ar(t,e,n){const o=Pn(t,e);let a=null;for(const r of o)r<=n+Yo&&(a===null||r>a)&&(a=r);return a===null||n-a>Yo?null:a}function Ir(t,e){let n=t,o=e;return e>O.minZ-St&&e<O.maxZ+St&&(n=bt.clamp(t,O.minX+St,O.maxX-St)),t>O.minX-St&&t<O.maxX+St&&(o=Math.max(e,O.minZ+St)),{x:n,z:o}}class Rr{constructor(e,n){if(this.camera=e,this.domElement=n,this.enabled=!1,this.euler=new wn(0,0,0,"YXZ"),this.camera.rotation.set(0,0,0),this.camera.rotation.order="YXZ",this.camera.position.set(0,Ct,8),this.keys={forward:!1,backward:!1,left:!1,right:!1,run:!1},this.velocity=new At(0,0),this.bobPhase=0,this.bobOffset=0,this.liftOffset=0,this.groundY=this.camera.position.y-Ct,this.moveTouch=null,this.lookTouch=null,!document.getElementById("lu-joy-style")){const o=document.createElement("style");o.id="lu-joy-style",o.textContent=`
