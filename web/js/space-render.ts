...
export { partY, warmBuildingTexCache, ART_SCREEN_CAP, UNIQUE_TEX_TYPES, unshareMaterial } from './space-parts.js';
export { spaceDims, DOOR_W, buildSpaceGroup, buildSpaceGroupChunked, addRoomLighting, disposeSpaceGroup, buildPartPreview, uniqueTexCount } from './space-assembler.js';
